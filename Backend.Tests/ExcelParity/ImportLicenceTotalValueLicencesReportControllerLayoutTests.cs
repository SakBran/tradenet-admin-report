...
/// (Frontend/src/Report/Page/ImportLicenceTotalValueLicencesReport.tsx). The page is
...
/// </summary>
public sealed class ImportLicenceTotalValueLicencesReportControllerLayoutTests
{
    private static readonly Type ControllerType =
        typeof(ImportLicenceTotalValueLicencesReportController);

    private static ImportLicenceTotalValueLicencesReportRequest Request() => new()
    {
        Type = "Oversea",
    ...
    private static ExcelReportLayout Layout()
        => new ImportLicenceTotalValueLicencesReportController(null!, null!)
    ...
    public void The_title_line_is_the_pages_heading_with_the_requests_date_range()
    {
        ...
        Assert.Equal(
            "Import Licences Total Value & Licences (01/02/2025) To (28/02/2025)",
    ...
    public void The_sheet_writes_both_tables_then_the_total_usd_value_line()
    {
        ...
        using (var writer = new StreamingExcelWriter(ms, "Import Licence Total Value & Licences Report", layout))
        {
