...
/// (Frontend/src/Report/Page/BorderImportLicenceTotalValueLicencesReport.tsx). The page is
...
/// </summary>
public sealed class BorderImportLicenceTotalValueLicencesReportControllerLayoutTests
{
    private static readonly Type ControllerType =
        typeof(BorderImportLicenceTotalValueLicencesReportController);

    private static BorderImportLicenceTotalValueLicencesReportRequest Request() => new()
    {
        Type = "Border",
    ...
    private static ExcelReportLayout Layout()
        => new BorderImportLicenceTotalValueLicencesReportController(null!, null!, null!)
    ...
    public void The_title_line_is_the_pages_heading_with_the_requests_date_range()
    {
        ...
        Assert.Equal(
            "Border Import Licences Total Value & Licences (01/02/2025) To (28/02/2025)",
    ...
    public void The_sheet_writes_both_tables_then_the_total_usd_value_line()
    {
        ...
        using (var writer = new StreamingExcelWriter(ms, "Border Import Licence Total Value & Licences Report", layout))
        {
