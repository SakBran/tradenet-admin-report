...
/// (Frontend/src/Report/Page/BorderExportLicenceTotalValueLicencesReport.tsx). The page is
...
/// </summary>
public sealed class BorderExportLicenceTotalValueLicencesReportControllerLayoutTests
{
    private static readonly Type ControllerType =
        typeof(BorderExportLicenceTotalValueLicencesReportController);

    private static BorderExportLicenceTotalValueLicencesReportRequest Request() => new()
    {
        Type = "Border",
    ...
    private static ExcelReportLayout Layout()
        => new BorderExportLicenceTotalValueLicencesReportController(null!, null!, null!)
    ...
    public void The_title_line_is_the_pages_heading_with_the_requests_date_range()
    {
        ...
        Assert.Equal(
            "Border Export Licences Total Value & Licences (01/02/2025) To (28/02/2025)",
    ...
    public void The_sheet_writes_both_tables_then_the_total_usd_value_line()
    {
        ...
        using (var writer = new StreamingExcelWriter(ms, "Border Export Licence Total Value & Licences Report", layout))
        {
