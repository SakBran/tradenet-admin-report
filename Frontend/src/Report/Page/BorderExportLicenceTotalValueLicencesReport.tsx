...
const config = reportConfigs.BorderExportLicenceTotalValueLicencesReport;
...
const BorderExportLicenceTotalValueLicencesReport = () => {
  ...
  useEffect(() => {
    ...
    Promise.all([
      ...
      axiosInstance.get<LookupOption[]>('ReportLookups/borderExportLicenceSections'),
    ])
  ...
  const heading = appliedRange
    ? `Border Export Licences Total Value & Licences (${appliedRange[0].format(
        'DD/MM/YYYY'
...
export default BorderExportLicenceTotalValueLicencesReport;
