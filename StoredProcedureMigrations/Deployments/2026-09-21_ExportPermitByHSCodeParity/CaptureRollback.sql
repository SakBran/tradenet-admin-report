...
/* -------------------------------------------------------------------------------------
   ...
   (353 distinct (HSCodeId, Currency) pairs / 1,147 distinct licences for 2025). The old
   app does no grouping in SQL at all (Business/Reports.cs GetHSCodeReport just projects
   the rows) - the grouping happens in HSCodeReport.rdlc's row group.
   ...
   count, because the overwritten version no longer returns the 9 raw item columns).
   ------------------------------------------------------------------------------------- */
