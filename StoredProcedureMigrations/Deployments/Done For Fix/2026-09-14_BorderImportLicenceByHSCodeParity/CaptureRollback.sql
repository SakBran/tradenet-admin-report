/* =====================================================================================
   ...
   one (~900 lines) - check the tail of the captured text really ends with its last END.
   ===================================================================================== */
...
/* -------------------------------------------------------------------------------------
   ...
   (2,881 distinct (HSCodeId, Currency) pairs / 12,435 distinct licences for 2025). The old
   app does no grouping in SQL at all (Business/Reports.cs GetHSCodeReport just projects
   the rows) - the grouping happens in BorderHSCodeReport.rdlc's row group.
   ...
   overwritten (and VerifyDeployment.sql section 3's INSERT..EXEC will fail on the column
   count, because the overwritten version no longer returns the 10 raw item columns).
   ------------------------------------------------------------------------------------- */
