...
namespace Backend.Controllers.Report
{
    ...
    public class BorderExportPermitDailyReportNewPermitReportController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<ActionResult<ApiResult<sp_ExportPermitDetailReportResult>>> Post([FromBody] BorderExportPermitDailyReportNewPermitReportRequest? request)
        {
        ...
        public async Task<IActionResult> Excel([FromBody] BorderExportPermitDailyReportNewPermitReportRequest? request)
        {
            ...
            try
            {
                fileBytes = await sp_ExportPermitDetailReport_Fast.CreateExcelWorkbookAsync(_context, _cache, procedureRequest!, request!, "Border Export Permit Daily Report (New Permit Report)");
            }
