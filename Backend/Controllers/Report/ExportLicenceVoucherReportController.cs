...
namespace Backend.Controllers.Report
{
    ...
    public class ExportLicenceVoucherReportController : ControllerBase
    {
        private readonly TradeNetDbContext _context;

        public ExportLicenceVoucherReportController(TradeNetDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Excel([FromBody] ExportLicenceVoucherReportRequest? request)
        {
            ...
            return File(
                ...
                "ExportLicenceVoucherReport.xlsx");
        }
