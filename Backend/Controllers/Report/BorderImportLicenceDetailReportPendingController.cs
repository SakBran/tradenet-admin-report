...
namespace Backend.Controllers.Report
{
    ...
    public class BorderImportLicenceDetailReportPendingController : ControllerBase
    {
        private readonly TradeNetDbContext _context;
        private readonly IMemoryCache _cache;

        public BorderImportLicenceDetailReportPendingController(TradeNetDbContext context, IMemoryCache cache)
        {
            _context = context;
            _cache = cache;
        }
        ...
        public async Task<IActionResult> Excel([FromBody] BorderImportLicenceDetailReportPendingRequest? request)
        {
            ...
            return File(
                ...
                "BorderImportLicenceDetailReportPending.xlsx");
        }
