...
namespace Backend.Controllers.Report
{
    ...
    public class ImportPermitCancellationReportController : ControllerBase, IStreamingExcelReport
    {
        ...
        public ImportPermitCancellationReportController(TradeNetDbContext context, IExcelExportJobService excelExportJobs)
        {
            _context = context;
        ...
        [HttpPost]
        public async Task<ActionResult<ApiResult<sp_CancelReportResult>>> Post([FromBody] ImportPermitCancellationReportRequest? request)
        {
        ...
        [HttpPost("Excel")]
        public async Task<IActionResult> Excel([FromBody] ImportPermitCancellationReportRequest? request)
        {
        ...
        public string ExcelWorksheetTitle => "Import Permit Cancellation Report";
        public Type ExcelRequestType => typeof(ImportPermitCancellationReportRequest);

        [NonAction]
        public Task WriteRowsAsync(object request, IExcelRowSink sink, int chunkSize, CancellationToken cancellationToken)
            => WriteRowsAsync((ImportPermitCancellationReportRequest)request, sink, chunkSize, cancellationToken);

        private async Task WriteRowsAsync(
            ImportPermitCancellationReportRequest request,
            IExcelRowSink sink,
            int chunkSize,
    ...
    public sealed class ImportPermitCancellationReportRequest : ReportQueryRequest
    {
