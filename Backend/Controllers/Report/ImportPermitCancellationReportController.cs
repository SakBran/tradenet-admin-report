...
namespace Backend.Controllers.Report
{
    ...
    public class ImportPermitCancellationReportController : ControllerBase
    {
        ...
        public ImportPermitCancellationReportController(TradeNetDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Excel([FromBody] ImportPermitCancellationReportRequest? request)
        {
            ...
            var data = rows.Select(row => row.ToResult()).ToList();
            var fileBytes = ExcelGenerator.CreateWorkbook(data, "Import Permit Cancellation Report");

            return File(fileBytes, ExcelGenerator.ContentType, "ImportPermitCancellationReport.xlsx");
        }
