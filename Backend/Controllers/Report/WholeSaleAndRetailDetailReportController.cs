...
namespace Backend.Controllers.Report
{
    ...
    public class WholeSaleAndRetailDetailReportController : ControllerBase
    {
        private const string FormType = "Whole Sale and Retail";

        private readonly TradeNetDbContext _context;

        public WholeSaleAndRetailDetailReportController(TradeNetDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Excel([FromBody] WholeSaleAndRetailDetailReportRequest? request)
        {
            ...
            try
            {
                fileBytes = await ExcelGenerator.CreateWorkbookAsync(
                    query,
                    request!,
                    "Whole Sale and Retail Detail Report");
            }
            ...
            return File(
                ...
                "WholeSaleAndRetailDetailReport.xlsx");
        }
