...
namespace Backend.Controllers.Report
{
    ...
    public class BorderExportLicenceCancellationReportController : ControllerBase
    {
        ...
        public BorderExportLicenceCancellationReportController(TradeNetDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Excel([FromBody] BorderExportLicenceCancellationReportRequest? request)
        {
            ...
            var data = rows.Select(row => row.ToResult()).ToList();
            var fileBytes = ExcelGenerator.CreateWorkbook(data, "Border Export Licence Cancellation Report");

            return File(fileBytes, ExcelGenerator.ContentType, "BorderExportLicenceCancellationReport.xlsx");
        }
