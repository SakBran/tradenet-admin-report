...
namespace Backend.Controllers.Report
{
    ...
    public class ImportLicenceByHSCodeReportController : ControllerBase, IStreamingExcelReport
    {
        private const string ReportKey = "ImportLicenceByHSCodeReport";

        private readonly TradeNetDbContext _context;
        private readonly IExcelExportJobService _excelExportJobs;

        public ImportLicenceByHSCodeReportController(TradeNetDbContext context, IExcelExportJobService excelExportJobs)
        {
            _context = context;
        ...
        [HttpPost]
        public async Task<ActionResult<ApiResult<ReportAggregateResult>>> Post([FromBody] ImportLicenceByHSCodeReportRequest? request)
        {
        ...
        [HttpPost("Excel")]
        public async Task<IActionResult> Excel([FromBody] ImportLicenceByHSCodeReportRequest? request)
        {
        ...
        public string ExcelWorksheetTitle => "Import Licence By HS Code Report";
        public Type ExcelRequestType => typeof(ImportLicenceByHSCodeReportRequest);

        [NonAction]
        public Task WriteRowsAsync(object request, IExcelRowSink sink, int chunkSize, CancellationToken cancellationToken)
            => WriteRowsAsync((ImportLicenceByHSCodeReportRequest)request, sink, chunkSize, cancellationToken);

        private async Task WriteRowsAsync(
            ImportLicenceByHSCodeReportRequest request,
            IExcelRowSink sink,
            int chunkSize,
            CancellationToken cancellationToken)
        {
            ...
            // sp_HSCodeReport.CreateAggregateResultAsync, which trims @HSCode before the LIKE (the
            // deployed sp_HSCodeReport_pagination does LTRIM/RTRIM too); this path calls
            ...
            // result.Currency") when no Import Section is chosen, and through AggregateQuery
    ...
    public sealed class ImportLicenceByHSCodeReportRequest : ReportQueryRequest
    {
