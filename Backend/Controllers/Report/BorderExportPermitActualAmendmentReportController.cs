...
namespace Backend.Controllers.Report
{
    ...
    public class BorderExportPermitActualAmendmentReportController : ControllerBase
    {
        private readonly TradeNetDbContext _context;

        public BorderExportPermitActualAmendmentReportController(TradeNetDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Excel([FromBody] BorderExportPermitActualAmendmentReportRequest? request)
        {
            ...
            try
            {
                fileBytes = await ExcelGenerator.CreateWorkbookAsync(
                    query,
                    request!,
                    "Border Export Permit Actual Amendment Report");
            }
