...
namespace Backend.Controllers.Report
{
    ...
    public class BorderExportPermitExtensionReportController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<ActionResult<ApiResult<sp_ExtensionReportResult>>> Post([FromBody] BorderExportPermitExtensionReportRequest? request)
        {
    ...
    public sealed class BorderExportPermitExtensionReportRequest : ReportQueryRequest
    {
