...
namespace Backend.Controllers.Report
{
    ...
    public class BorderExportPermitAmendmentReportController : ControllerBase, IStreamingExcelReport
    {
        ...
        public BorderExportPermitAmendmentReportController(TradeNetDbContext context, IExcelExportJobService excelExportJobs)
        {
            _context = context;
        ...
        [HttpPost]
        public async Task<ActionResult<ApiResult<sp_AmendReportResult>>> Post([FromBody] BorderExportPermitAmendmentReportRequest? request)
        {
        ...
        [HttpPost("Excel")]
        public async Task<IActionResult> Excel([FromBody] BorderExportPermitAmendmentReportRequest? request)
        {
        ...
        public string ExcelWorksheetTitle => "Border Export Permit Amendment Report";
        public Type ExcelRequestType => typeof(BorderExportPermitAmendmentReportRequest);

        [NonAction]
        public Task WriteRowsAsync(object request, IExcelRowSink sink, int chunkSize, CancellationToken cancellationToken)
            => WriteRowsAsync((BorderExportPermitAmendmentReportRequest)request, sink, chunkSize, cancellationToken);

        private async Task WriteRowsAsync(
            BorderExportPermitAmendmentReportRequest request,
            IExcelRowSink sink,
            int chunkSize,
    ...
    public sealed class BorderExportPermitAmendmentReportRequest : ReportQueryRequest
    {
