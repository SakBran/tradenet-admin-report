...
namespace Backend.Controllers.Report
{
    ...
    public class BorderExportLicenceTotalValueLicencesReportController : ControllerBase
    {
        private readonly TradeNetDbContext _context;
        private readonly IMemoryCache _cache;

        public BorderExportLicenceTotalValueLicencesReportController(TradeNetDbContext context, IMemoryCache cache)
        {
            _context = context;
            _cache = cache;
        }
        ...
        [HttpPost]
        public async Task<ActionResult<ApiResult<ReportAggregateResult>>> Post([FromBody] BorderExportLicenceTotalValueLicencesReportRequest? request)
        {
        ...
        public async Task<IActionResult> Excel([FromBody] BorderExportLicenceTotalValueLicencesReportRequest? request)
        {
            ...
            return File(
                ...
                "BorderExportLicenceTotalValueLicencesReport.xlsx");
        }
