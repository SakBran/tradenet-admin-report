...
namespace Backend.Controllers.Report
{
    ...
    public class ImportLicencePendingReportController : ControllerBase, IStreamingExcelReport
    {
        private const string ReportKey = "ImportLicencePendingReport";
        ...
        public ImportLicencePendingReportController(TradeNetDbContext context, IExcelExportJobService excelExportJobs)
        {
            _context = context;
        ...
        public string ExcelWorksheetTitle => "Import Licence Pending Report";
        public Type ExcelRequestType => typeof(ImportLicencePendingReportRequest);

        [NonAction]
        public Task WriteRowsAsync(object request, IExcelRowSink sink, int chunkSize, CancellationToken cancellationToken)
            => WriteRowsAsync((ImportLicencePendingReportRequest)request, sink, chunkSize, cancellationToken);
