...
namespace Backend.Controllers.Report
{
    ...
    public class ImportPermitByHSCodeReportController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<ActionResult<ApiResult<sp_HSCodeReportResult>>> Post([FromBody] ImportPermitByHSCodeReportRequest? request)
        {
    ...
    public sealed class ImportPermitByHSCodeReportRequest : ReportQueryRequest
    {
