...
namespace Backend.Controllers.Report
{
    ...
    public class ExportLicenceByMethodReportController : ControllerBase
    {
        private readonly TradeNetDbContext _context;
        private readonly IMemoryCache _cache;

        public ExportLicenceByMethodReportController(TradeNetDbContext context, IMemoryCache cache)
        {
            _context = context;
            _cache = cache;
        }
        ...
        [HttpPost]
        public async Task<ActionResult<ApiResult<sp_ExportLicenceDetailReportResult>>> Post([FromBody] ExportLicenceByMethodReportRequest? request)
        {
        ...
        public async Task<IActionResult> Excel([FromBody] ExportLicenceByMethodReportRequest? request)
        {
            ...
            try
            {
                fileBytes = await sp_ExportLicenceDetailReport_Fast.CreateExcelWorkbookAsync(
                    ...
                    procedureRequest!,
                    request!,
                    "Export Licence By Method Report");
            }
            ...
            return File(
                ...
                "ExportLicenceByMethodReport.xlsx");
        }
