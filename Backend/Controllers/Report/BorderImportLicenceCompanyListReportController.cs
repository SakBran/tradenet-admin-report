...
namespace Backend.Controllers.Report
{
    ...
    public class BorderImportLicenceCompanyListReportController : ControllerBase, IStreamingExcelReport
    {
        private const string ReportKey = "BorderImportLicenceCompanyListReport";

        private readonly TradeNetDbContext _context;
        private readonly IMemoryCache _cache;
        private readonly IExcelExportJobService _excelExportJobs;

        public BorderImportLicenceCompanyListReportController(TradeNetDbContext context, IMemoryCache cache, IExcelExportJobService excelExportJobs)
        {
            _context = context;
            _cache = cache;
        ...
        [HttpPost]
        public async Task<ActionResult<ApiResult<ReportAggregateResult>>> Post([FromBody] BorderImportLicenceCompanyListReportRequest? request)
        {
        ...
        public string ExcelWorksheetTitle => "Border Import Licence Company List Report";
        public Type ExcelRequestType => typeof(BorderImportLicenceCompanyListReportRequest);

        [NonAction]
        public Task WriteRowsAsync(object request, IExcelRowSink sink, int chunkSize, CancellationToken cancellationToken)
            => WriteRowsAsync((BorderImportLicenceCompanyListReportRequest)request, sink, chunkSize, cancellationToken);
