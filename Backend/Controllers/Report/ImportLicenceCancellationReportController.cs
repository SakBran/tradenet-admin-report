...
namespace Backend.Controllers.Report
{
    ...
    public class ImportLicenceCancellationReportController : ControllerBase
    {
        ...
        public ImportLicenceCancellationReportController(TradeNetDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Excel([FromBody] ImportLicenceCancellationReportRequest? request)
        {
            ...
            var data = rows.Select(row => row.ToResult()).ToList();
            var fileBytes = ExcelGenerator.CreateWorkbook(data, "Import Licence Cancellation Report");

            return File(fileBytes, ExcelGenerator.ContentType, "ImportLicenceCancellationReport.xlsx");
        }
