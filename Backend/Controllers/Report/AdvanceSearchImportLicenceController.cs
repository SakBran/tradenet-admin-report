...
{
    /// <summary>
    /// Advance Search for Import Licence -- the old admin's Advance Search screen scoped to <c>Import Licence</c>
    ...
    public class AdvanceSearchImportLicenceController : ControllerBase, IStreamingExcelReport
    {
        private const string ReportKey = "AdvanceSearchImportLicence";
        private const string LicenceOrPermitType = sp_AdvanceSearch.AdvanceSearchType.ImportLicence;

        private readonly TradeNetDbContext _context;
        private readonly IExcelExportJobService _excelExportJobs;

        public AdvanceSearchImportLicenceController(TradeNetDbContext context, IExcelExportJobService excelExportJobs)
        {
            _context = context;
        ...
        public async Task<ActionResult<ApiResult<sp_AdvanceSearchResult>>> Post(
            [FromBody] AdvanceSearchImportLicenceRequest? request)
        {
        ...
        [HttpPost("Excel")]
        public async Task<IActionResult> Excel([FromBody] AdvanceSearchImportLicenceRequest? request)
        {
        ...
        public string ExcelWorksheetTitle => "Advance Search for Import Licence";
        public Type ExcelRequestType => typeof(AdvanceSearchImportLicenceRequest);

        [NonAction]
        public Task WriteRowsAsync(object request, IExcelRowSink sink, int chunkSize, CancellationToken cancellationToken)
            => WriteRowsAsync((AdvanceSearchImportLicenceRequest)request, sink, chunkSize, cancellationToken);

        private Task WriteRowsAsync(
            AdvanceSearchImportLicenceRequest request,
            IExcelRowSink sink,
            int chunkSize,
    ...
    public sealed class AdvanceSearchImportLicenceRequest : ReportQueryRequest
    {
