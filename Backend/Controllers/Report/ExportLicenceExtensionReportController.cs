...
namespace Backend.Controllers.Report
{
    ...
    public class ExportLicenceExtensionReportController : ControllerBase, IStreamingExcelReport
    {
        private const string ReportKey = "ExportLicenceExtensionReport";
        ...
        public ExportLicenceExtensionReportController(TradeNetDbContext context, IExcelExportJobService excelExportJobs)
        {
            _context = context;
        ...
        [HttpPost]
        public async Task<ActionResult<ApiResult<sp_ExtensionReportResult>>> Post([FromBody] ExportLicenceExtensionReportRequest? request)
        {
        ...
        [HttpPost("Excel")]
        public async Task<IActionResult> Excel([FromBody] ExportLicenceExtensionReportRequest? request)
        {
        ...
        public string ExcelWorksheetTitle => "Export Licence Extension Report";
        public Type ExcelRequestType => typeof(ExportLicenceExtensionReportRequest);

        [NonAction]
        public Task WriteRowsAsync(object request, IExcelRowSink sink, int chunkSize, CancellationToken cancellationToken)
            => WriteRowsAsync((ExportLicenceExtensionReportRequest)request, sink, chunkSize, cancellationToken);

        private async Task WriteRowsAsync(
            ExportLicenceExtensionReportRequest request,
            IExcelRowSink sink,
            int chunkSize,
    ...
    public sealed class ExportLicenceExtensionReportRequest : ReportQueryRequest
    {
