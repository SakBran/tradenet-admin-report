...
namespace Backend.Controllers.Report
{
    ...
    public class ExportPermitDetailReportController : ControllerBase
    {
        private readonly TradeNetDbContext _context;
        private readonly IMemoryCache _cache;

        public ExportPermitDetailReportController(TradeNetDbContext context, IMemoryCache cache)
        {
            _context = context;
            _cache = cache;
        }
        ...
        public async Task<IActionResult> Excel([FromBody] ExportPermitDetailReportRequest? request)
        {
            ...
            try
            {
                fileBytes = await sp_ExportPermitDetailReport_Fast.CreateExcelWorkbookAsync(_context, _cache, procedureRequest!, request!, "Export Permit Detail Report");
            }
