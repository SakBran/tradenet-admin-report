...
namespace Backend.Controllers.Report
{
    ...
    public class RetailRegistrationByVoucherController : ControllerBase
    {
        private const string RegistrationType = "Retail";

        private readonly TradeNetDbContext _context;

        public RetailRegistrationByVoucherController(TradeNetDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Excel([FromBody] RetailRegistrationByVoucherRequest? request)
        {
            ...
            try
            {
                fileBytes = await ExcelGenerator.CreateWorkbookAsync(
                    query,
                    request!,
                    "Retail Registration By Voucher");
            }
            ...
            return File(
                ...
                "RetailRegistrationByVoucher.xlsx");
        }
