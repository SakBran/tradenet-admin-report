...
namespace Backend.Controllers.Report
{
    ...
    public class ExportPermitAmendmentReportController : ControllerBase, IStreamingExcelReport
    {
        ...
        public ExportPermitAmendmentReportController(TradeNetDbContext context, IExcelExportJobService excelExportJobs)
        {
            _context = context;
        ...
        [HttpPost]
        public async Task<ActionResult<ApiResult<sp_AmendReportResult>>> Post([FromBody] ExportPermitAmendmentReportRequest? request)
        {
        ...
        [HttpPost("Excel")]
        public async Task<IActionResult> Excel([FromBody] ExportPermitAmendmentReportRequest? request)
        {
        ...
        public string ExcelWorksheetTitle => "Export Permit Amendment Report";
        public Type ExcelRequestType => typeof(ExportPermitAmendmentReportRequest);

        [NonAction]
        public Task WriteRowsAsync(object request, IExcelRowSink sink, int chunkSize, CancellationToken cancellationToken)
            => WriteRowsAsync((ExportPermitAmendmentReportRequest)request, sink, chunkSize, cancellationToken);

        private async Task WriteRowsAsync(
            ExportPermitAmendmentReportRequest request,
            IExcelRowSink sink,
            int chunkSize,
    ...
    public sealed class ExportPermitAmendmentReportRequest : ReportQueryRequest
    {
