...
namespace Backend.Controllers.Report
{
    ...
    public class ExportPermitAmendmentReportController : ControllerBase
    {
        ...
        public ExportPermitAmendmentReportController(TradeNetDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Excel([FromBody] ExportPermitAmendmentReportRequest? request)
        {
            ...
            var data = rows.Select(row => row.ToResult()).ToList();
            var fileBytes = ExcelGenerator.CreateWorkbook(data, "Export Permit Amendment Report");

            return File(fileBytes, ExcelGenerator.ContentType, "ExportPermitAmendmentReport.xlsx");
        }
