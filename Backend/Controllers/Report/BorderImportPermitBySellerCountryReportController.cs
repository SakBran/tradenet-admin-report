...
namespace Backend.Controllers.Report
{
    ...
    public class BorderImportPermitBySellerCountryReportController : ControllerBase, IStreamingExcelReport
    {
        private const string ReportKey = "BorderImportPermitBySellerCountryReport";

        private readonly TradeNetDbContext _context;
        private readonly IMemoryCache _cache;
        private readonly IExcelExportJobService _excelExportJobs;

        public BorderImportPermitBySellerCountryReportController(TradeNetDbContext context, IMemoryCache cache, IExcelExportJobService excelExportJobs)
        {
            _context = context;
            _cache = cache;
        ...
        [HttpPost]
        public async Task<ActionResult<ApiResult<ReportAggregateResult>>> Post([FromBody] BorderImportPermitBySellerCountryReportRequest? request)
        {
            ...
            var result = await sp_ImportPermitDetailReport_Fast.CreateAggregateResultAsync(
                ...
                // across currencies is meaningless (BorderImportPermitBySellerCountryReport.rdlc).
        ...
        [HttpPost("Excel")]
        public async Task<IActionResult> Excel([FromBody] BorderImportPermitBySellerCountryReportRequest? request)
        {
        ...
        public string ExcelWorksheetTitle => "Border Import Permit By Seller Country Report";
        public Type ExcelRequestType => typeof(BorderImportPermitBySellerCountryReportRequest);

        [NonAction]
        public Task WriteRowsAsync(object request, IExcelRowSink sink, int chunkSize, CancellationToken cancellationToken)
            => WriteRowsAsync((BorderImportPermitBySellerCountryReportRequest)request, sink, chunkSize, cancellationToken);

        private async Task WriteRowsAsync(
            BorderImportPermitBySellerCountryReportRequest request,
            IExcelRowSink sink,
            int chunkSize,
    ...
    public sealed class BorderImportPermitBySellerCountryReportRequest : ReportQueryRequest
    {
