...
namespace Backend.Controllers.Report
{
    ...
    public class ExportLicenceCompanyListReportController : ControllerBase
    {
        private readonly TradeNetDbContext _context;
        private readonly IMemoryCache _cache;

        public ExportLicenceCompanyListReportController(TradeNetDbContext context, IMemoryCache cache)
        {
            _context = context;
            _cache = cache;
        }
        ...
        [HttpPost]
        public async Task<ActionResult<ApiResult<sp_ExportLicenceDetailReportResult>>> Post([FromBody] ExportLicenceCompanyListReportRequest? request)
        {
        ...
        public async Task<IActionResult> Excel([FromBody] ExportLicenceCompanyListReportRequest? request)
        {
            ...
            try
            {
                fileBytes = await sp_ExportLicenceDetailReport_Fast.CreateExcelWorkbookAsync(
                    ...
                    procedureRequest!,
                    request!,
                    "Export Licence Company List Report");
            }
            ...
            return File(
                ...
                "ExportLicenceCompanyListReport.xlsx");
        }
