...
namespace Backend.Controllers.Report
{
    ...
    public class RetailSummaryReportController : ControllerBase, IStreamingExcelReport
    {
        private const string ReportKey = "RetailSummaryReport";
        private const string FormType = "Retail";

        private readonly TradeNetDbContext _context;
        private readonly IExcelExportJobService _excelExportJobs;

        public RetailSummaryReportController(TradeNetDbContext context, IExcelExportJobService excelExportJobs)
        {
            _context = context;
        ...
        public string ExcelWorksheetTitle => "Retail Summary Report";
        public Type ExcelRequestType => typeof(RetailSummaryReportRequest);

        [NonAction]
        public Task WriteRowsAsync(object request, IExcelRowSink sink, int chunkSize, CancellationToken cancellationToken)
            => WriteRowsAsync((RetailSummaryReportRequest)request, sink, chunkSize, cancellationToken);
