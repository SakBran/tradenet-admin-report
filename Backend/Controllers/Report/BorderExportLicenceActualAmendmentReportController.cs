...
namespace Backend.Controllers.Report
{
    ...
    public class BorderExportLicenceActualAmendmentReportController : ControllerBase, IStreamingExcelReport
    {
        private const string ReportKey = "BorderExportLicenceActualAmendmentReport";
        ...
        public BorderExportLicenceActualAmendmentReportController(TradeNetDbContext context, IExcelExportJobService excelExportJobs)
        {
            _context = context;
        ...
        public string ExcelWorksheetTitle => "Border Export Licence Actual Amendment Report";
        public Type ExcelRequestType => typeof(BorderExportLicenceActualAmendmentReportRequest);

        [NonAction]
        public Task WriteRowsAsync(object request, IExcelRowSink sink, int chunkSize, CancellationToken cancellationToken)
            => WriteRowsAsync((BorderExportLicenceActualAmendmentReportRequest)request, sink, chunkSize, cancellationToken);
