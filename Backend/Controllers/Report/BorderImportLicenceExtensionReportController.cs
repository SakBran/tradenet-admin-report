...
namespace Backend.Controllers.Report
{
    ...
    public class BorderImportLicenceExtensionReportController : ControllerBase, IStreamingExcelReport
    {
        private const string ReportKey = "BorderImportLicenceExtensionReport";
        ...
        public BorderImportLicenceExtensionReportController(TradeNetDbContext context, IExcelExportJobService excelExportJobs)
        {
            _context = context;
        ...
        [HttpPost]
        public async Task<ActionResult<ApiResult<sp_ExtensionReportResult>>> Post([FromBody] BorderImportLicenceExtensionReportRequest? request)
        {
        ...
        [HttpPost("Excel")]
        public async Task<IActionResult> Excel([FromBody] BorderImportLicenceExtensionReportRequest? request)
        {
        ...
        public string ExcelWorksheetTitle => "Border Import Licence Extension Report";
        public Type ExcelRequestType => typeof(BorderImportLicenceExtensionReportRequest);

        [NonAction]
        public Task WriteRowsAsync(object request, IExcelRowSink sink, int chunkSize, CancellationToken cancellationToken)
            => WriteRowsAsync((BorderImportLicenceExtensionReportRequest)request, sink, chunkSize, cancellationToken);

        private async Task WriteRowsAsync(
            BorderImportLicenceExtensionReportRequest request,
            IExcelRowSink sink,
            int chunkSize,
    ...
    public sealed class BorderImportLicenceExtensionReportRequest : ReportQueryRequest
    {
