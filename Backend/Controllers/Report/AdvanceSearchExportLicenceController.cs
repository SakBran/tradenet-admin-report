...
{
    /// <summary>
    /// Advance Search for Export Licence -- the old admin's Advance Search screen scoped to <c>Export Licence</c>
    ...
    public class AdvanceSearchExportLicenceController : ControllerBase, IStreamingExcelReport
    {
        private const string ReportKey = "AdvanceSearchExportLicence";
        private const string LicenceOrPermitType = sp_AdvanceSearch.AdvanceSearchType.ExportLicence;

        private readonly TradeNetDbContext _context;
        private readonly IExcelExportJobService _excelExportJobs;

        public AdvanceSearchExportLicenceController(TradeNetDbContext context, IExcelExportJobService excelExportJobs)
        {
            _context = context;
        ...
        public async Task<ActionResult<ApiResult<sp_AdvanceSearchResult>>> Post(
            [FromBody] AdvanceSearchExportLicenceRequest? request)
        {
        ...
        [HttpPost("Excel")]
        public async Task<IActionResult> Excel([FromBody] AdvanceSearchExportLicenceRequest? request)
        {
        ...
        public string ExcelWorksheetTitle => "Advance Search for Export Licence";
        public Type ExcelRequestType => typeof(AdvanceSearchExportLicenceRequest);

        [NonAction]
        public Task WriteRowsAsync(object request, IExcelRowSink sink, int chunkSize, CancellationToken cancellationToken)
            => WriteRowsAsync((AdvanceSearchExportLicenceRequest)request, sink, chunkSize, cancellationToken);

        private Task WriteRowsAsync(
            AdvanceSearchExportLicenceRequest request,
            IExcelRowSink sink,
            int chunkSize,
    ...
    public sealed class AdvanceSearchExportLicenceRequest : ReportQueryRequest
    {
