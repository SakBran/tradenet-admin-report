...
namespace Backend.Controllers.Report
{
    ...
    public class BorderImportLicenceByMethodReportController : ControllerBase, IStreamingExcelReport
    {
        ...
        public BorderImportLicenceByMethodReportController(TradeNetDbContext context, IMemoryCache cache, IExcelExportJobService excelExportJobs)
        {
            _context = context;
            _cache = cache;
        ...
        [HttpPost]
        public async Task<ActionResult<ApiResult<ReportAggregateResult>>> Post([FromBody] BorderImportLicenceByMethodReportRequest? request)
        {
        ...
        [HttpPost("Excel")]
        public async Task<IActionResult> Excel([FromBody] BorderImportLicenceByMethodReportRequest? request)
        {
        ...
        public string ExcelWorksheetTitle => "Border Import Licence By Method Report";
        public Type ExcelRequestType => typeof(BorderImportLicenceByMethodReportRequest);

        [NonAction]
        public Task WriteRowsAsync(object request, IExcelRowSink sink, int chunkSize, CancellationToken cancellationToken)
            => WriteRowsAsync((BorderImportLicenceByMethodReportRequest)request, sink, chunkSize, cancellationToken);

        private async Task WriteRowsAsync(
            BorderImportLicenceByMethodReportRequest request,
            IExcelRowSink sink,
            int chunkSize,
    ...
    public sealed class BorderImportLicenceByMethodReportRequest : ReportQueryRequest
    {
