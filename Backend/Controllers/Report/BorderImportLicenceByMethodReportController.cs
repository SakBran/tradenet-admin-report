...
namespace Backend.Controllers.Report
{
    ...
    public class BorderImportLicenceByMethodReportController : ControllerBase
    {
        private readonly TradeNetDbContext _context;
        private readonly IMemoryCache _cache;

        public BorderImportLicenceByMethodReportController(TradeNetDbContext context, IMemoryCache cache)
        {
            _context = context;
            _cache = cache;
        }
        ...
        [HttpPost]
        public async Task<ActionResult<ApiResult<sp_ImportLicenceDetailReportResult>>> Post([FromBody] BorderImportLicenceByMethodReportRequest? request)
        {
        ...
        public async Task<IActionResult> Excel([FromBody] BorderImportLicenceByMethodReportRequest? request)
        {
            ...
            return File(
                ...
                "BorderImportLicenceByMethodReport.xlsx");
        }
