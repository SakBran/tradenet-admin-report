...
namespace Backend.Controllers.Report
{
    ...
    public class ExportPermitCancellationReportController : ControllerBase, IStreamingExcelReport
    {
        ...
        public ExportPermitCancellationReportController(TradeNetDbContext context, IExcelExportJobService excelExportJobs)
        {
            _context = context;
        ...
        [HttpPost]
        public async Task<ActionResult<ApiResult<sp_CancelReportResult>>> Post([FromBody] ExportPermitCancellationReportRequest? request)
        {
        ...
        [HttpPost("Excel")]
        public async Task<IActionResult> Excel([FromBody] ExportPermitCancellationReportRequest? request)
        {
        ...
        public string ExcelWorksheetTitle => "Export Permit Cancellation Report";
        public Type ExcelRequestType => typeof(ExportPermitCancellationReportRequest);

        [NonAction]
        public Task WriteRowsAsync(object request, IExcelRowSink sink, int chunkSize, CancellationToken cancellationToken)
            => WriteRowsAsync((ExportPermitCancellationReportRequest)request, sink, chunkSize, cancellationToken);

        private async Task WriteRowsAsync(
            ExportPermitCancellationReportRequest request,
            IExcelRowSink sink,
            int chunkSize,
    ...
    public sealed class ExportPermitCancellationReportRequest : ReportQueryRequest
    {
