...
namespace Backend.Controllers.Report
{
    ...
    public class ExportPermitCancellationReportController : ControllerBase
    {
        ...
        public ExportPermitCancellationReportController(TradeNetDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Excel([FromBody] ExportPermitCancellationReportRequest? request)
        {
            ...
            var data = rows.Select(row => row.ToResult()).ToList();
            var fileBytes = ExcelGenerator.CreateWorkbook(data, "Export Permit Cancellation Report");

            return File(fileBytes, ExcelGenerator.ContentType, "ExportPermitCancellationReport.xlsx");
        }
