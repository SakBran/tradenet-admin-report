...
{
    /// <summary>
    /// Advance Search for Border Export Permit -- the old admin's Advance Search screen scoped to <c>Border Export Permit</c>
    ...
    public class AdvanceSearchBorderExportPermitController : ControllerBase, IStreamingExcelReport
    {
        private const string ReportKey = "AdvanceSearchBorderExportPermit";
        private const string LicenceOrPermitType = sp_AdvanceSearch.AdvanceSearchType.BorderExportPermit;

        private readonly TradeNetDbContext _context;
        private readonly IExcelExportJobService _excelExportJobs;

        public AdvanceSearchBorderExportPermitController(TradeNetDbContext context, IExcelExportJobService excelExportJobs)
        {
            _context = context;
        ...
        public async Task<ActionResult<ApiResult<sp_AdvanceSearchResult>>> Post(
            [FromBody] AdvanceSearchBorderExportPermitRequest? request)
        {
        ...
        [HttpPost("Excel")]
        public async Task<IActionResult> Excel([FromBody] AdvanceSearchBorderExportPermitRequest? request)
        {
        ...
        public string ExcelWorksheetTitle => "Advance Search for Border Export Permit";
        public Type ExcelRequestType => typeof(AdvanceSearchBorderExportPermitRequest);

        [NonAction]
        public Task WriteRowsAsync(object request, IExcelRowSink sink, int chunkSize, CancellationToken cancellationToken)
            => WriteRowsAsync((AdvanceSearchBorderExportPermitRequest)request, sink, chunkSize, cancellationToken);

        private Task WriteRowsAsync(
            AdvanceSearchBorderExportPermitRequest request,
            IExcelRowSink sink,
            int chunkSize,
    ...
    public sealed class AdvanceSearchBorderExportPermitRequest : ReportQueryRequest
    {
