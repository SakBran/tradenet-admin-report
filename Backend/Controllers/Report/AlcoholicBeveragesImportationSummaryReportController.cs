...
namespace Backend.Controllers.Report
{
    ...
    public class AlcoholicBeveragesImportationSummaryReportController : ControllerBase, IStreamingExcelReport
    {
        private const string ReportKey = "AlcoholicBeveragesImportationSummaryReport";
        ...
        public string ExcelWorksheetTitle => "Alcoholic Beverages Importation Summary Report";
        public Type ExcelRequestType => typeof(AlcoholicBeveragesImportationSummaryReportRequest);

        [NonAction]
        public Task WriteRowsAsync(object request, IExcelRowSink sink, int chunkSize, CancellationToken cancellationToken)
            => WriteRowsAsync((AlcoholicBeveragesImportationSummaryReportRequest)request, sink, chunkSize, cancellationToken);
