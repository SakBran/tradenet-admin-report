...
namespace Backend.Controllers.Report
{
    ...
    public class ImportLicenceBySellerCountryReportController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<ActionResult<ApiResult<sp_ImportLicenceDetailReportResult>>> Post([FromBody] ImportLicenceBySellerCountryReportRequest? request)
        {
        ...
        public async Task<IActionResult> Excel([FromBody] ImportLicenceBySellerCountryReportRequest? request)
        {
            ...
            return File(
                ...
                "ImportLicenceBySellerCountryReport.xlsx");
        }
