...
namespace Backend.Controllers.Report
{
    ...
    public class ExportLicenceDetailReportController : ControllerBase
    {
        private readonly TradeNetDbContext _context;
        private readonly IMemoryCache _cache;

        public ExportLicenceDetailReportController(TradeNetDbContext context, IMemoryCache cache)
        {
            _context = context;
            _cache = cache;
        }
        ...
        public async Task<IActionResult> Excel([FromBody] ExportLicenceDetailReportRequest? request)
        {
            ...
            return File(
                ...
                "ExportLicenceDetailReport.xlsx");
        }
