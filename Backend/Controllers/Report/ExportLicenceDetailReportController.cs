...
namespace Backend.Controllers.Report
{
    ...
    public class ExportLicenceDetailReportController : ControllerBase, IStreamingExcelReport
    {
        ...
        public ExportLicenceDetailReportController(TradeNetDbContext context, IMemoryCache cache, IExcelExportJobService excelExportJobs)
        {
            _context = context;
            _cache = cache;
        ...
        [HttpPost]
        public async Task<ActionResult<ApiResult<sp_ExportLicenceDetailReportResult>>> Post([FromBody] ExportLicenceDetailReportRequest? request)
        {
        ...
        [HttpPost("Excel")]
        public async Task<IActionResult> Excel([FromBody] ExportLicenceDetailReportRequest? request)
        {
        ...
        public string ExcelWorksheetTitle => "Export Licence Detail Report";
        public Type ExcelRequestType => typeof(ExportLicenceDetailReportRequest);

        [NonAction]
        public Task WriteRowsAsync(object request, IExcelRowSink sink, int chunkSize, CancellationToken cancellationToken)
            => WriteRowsAsync((ExportLicenceDetailReportRequest)request, sink, chunkSize, cancellationToken);

        private async Task WriteRowsAsync(
            ExportLicenceDetailReportRequest request,
            IExcelRowSink sink,
            int chunkSize,
    ...
    public sealed class ExportLicenceDetailReportRequest : ReportQueryRequest
    {
