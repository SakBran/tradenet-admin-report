...
{
    /// <summary>
    /// EICC Border Licence/Permit Report -- the old admin's EICC &gt; Border Licence &amp; Permit &gt; Reports screen (<c>@Type = 'BorderLicencePermit'</c>).
    ///
    ...
    public class EICCBorderLicencePermitReportController : ControllerBase, IStreamingExcelReport
    {
        private const string ReportKey = "EICCBorderLicencePermitReport";
        private const string EICCType = sp_EICCReport.BorderLicencePermitType;

        private readonly TradeNetDbContext _context;
        private readonly IExcelExportJobService _excelExportJobs;

        public EICCBorderLicencePermitReportController(TradeNetDbContext context, IExcelExportJobService excelExportJobs)
        {
            _context = context;
        ...
        public async Task<ActionResult<ApiResult<sp_EICCReportResult>>> Post(
            [FromBody] EICCBorderLicencePermitReportRequest? request)
        {
        ...
        [HttpPost("Excel")]
        public async Task<IActionResult> Excel([FromBody] EICCBorderLicencePermitReportRequest? request)
        {
        ...
        public string ExcelWorksheetTitle => "EICC Border Licence and Permit Report";
        public Type ExcelRequestType => typeof(EICCBorderLicencePermitReportRequest);

        [NonAction]
        public Task WriteRowsAsync(object request, IExcelRowSink sink, int chunkSize, CancellationToken cancellationToken)
            => WriteRowsAsync((EICCBorderLicencePermitReportRequest)request, sink, chunkSize, cancellationToken);

        private async Task WriteRowsAsync(
            EICCBorderLicencePermitReportRequest request,
            IExcelRowSink sink,
            int chunkSize,
    ...
    public sealed class EICCBorderLicencePermitReportRequest : ReportQueryRequest
    {
        /// <summary>
