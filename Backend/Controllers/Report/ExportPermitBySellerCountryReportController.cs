...
namespace Backend.Controllers.Report
{
    ...
    public class ExportPermitBySellerCountryReportController : ControllerBase
    {
        private readonly TradeNetDbContext _context;
        private readonly IMemoryCache _cache;

        public ExportPermitBySellerCountryReportController(TradeNetDbContext context, IMemoryCache cache)
        {
            _context = context;
            _cache = cache;
        }
        ...
        public async Task<IActionResult> Excel([FromBody] ExportPermitBySellerCountryReportRequest? request)
        {
            ...
            try
            {
                fileBytes = await ExcelGenerator.CreateWorkbookAsync(
                    query,
                    request!,
                    "Export Permit By Seller Country Report");
            }
            ...
            return File(
                ...
                "ExportPermitBySellerCountryReport.xlsx");
        }
