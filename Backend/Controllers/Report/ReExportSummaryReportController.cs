...
namespace Backend.Controllers.Report
{
    ...
    public class ReExportSummaryReportController : ControllerBase, IStreamingExcelReport
    {
        private const string ReportKey = "ReExportSummaryReport";

        private readonly TradeNetDbContext _context;
        private readonly IExcelExportJobService _excelExportJobs;

        public ReExportSummaryReportController(TradeNetDbContext context, IExcelExportJobService excelExportJobs)
        {
            _context = context;
        ...
        public string ExcelWorksheetTitle => "Re-Export Summary Report";
        public Type ExcelRequestType => typeof(ReExportSummaryReportRequest);

        [NonAction]
        public Task WriteRowsAsync(object request, IExcelRowSink sink, int chunkSize, CancellationToken cancellationToken)
            => WriteRowsAsync((ReExportSummaryReportRequest)request, sink, chunkSize, cancellationToken);
