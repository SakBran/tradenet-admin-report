...
namespace Backend.Controllers.Report
{
    ...
    public class ListOfDirectorsController : ControllerBase
    {
        ...
        public ListOfDirectorsController(TradeNetDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Excel([FromBody] ListOfDirectorsRequest? request)
        {
            ...
            var data = rows.Select(row => row.ToResult()).ToList();
            var fileBytes = ExcelGenerator.CreateWorkbook(data, "List of Directors");

            return File(fileBytes, ExcelGenerator.ContentType, "ListOfDirectors.xlsx");
        }
