...
namespace Backend.Controllers.Report
{
    ...
    public class ListOfDirectorsController : ControllerBase, IStreamingExcelReport
    {
        private const string ReportKey = "ListOfDirectors";
        ...
        public ListOfDirectorsController(TradeNetDbContext context, IExcelExportJobService excelExportJobs)
        {
            _context = context;
        ...
        [HttpPost]
        public async Task<ActionResult<ApiResult<sp_DirectorListReportResult>>> Post([FromBody] ListOfDirectorsRequest? request)
        {
        ...
        [HttpPost("Excel")]
        public async Task<IActionResult> Excel([FromBody] ListOfDirectorsRequest? request)
        {
        ...
        public string ExcelWorksheetTitle => "List of Directors";
        public Type ExcelRequestType => typeof(ListOfDirectorsRequest);

        [NonAction]
        public Task WriteRowsAsync(object request, IExcelRowSink sink, int chunkSize, CancellationToken cancellationToken)
            => WriteRowsAsync((ListOfDirectorsRequest)request, sink, chunkSize, cancellationToken);

        private async Task WriteRowsAsync(
            ListOfDirectorsRequest request,
            IExcelRowSink sink,
            int chunkSize,
    ...
    public sealed class ListOfDirectorsRequest : ReportQueryRequest
    {
