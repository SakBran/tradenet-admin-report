...
namespace Backend.Controllers.Report
{
    ...
    public class ExportPermitActualAmendmentReportController : ControllerBase, IStreamingExcelReport
    {
        ...
        public ExportPermitActualAmendmentReportController(TradeNetDbContext context, IExcelExportJobService excelExportJobs)
        {
            _context = context;
        ...
        [HttpPost]
        public async Task<ActionResult<ApiResult<sp_ActualAmendReportResult>>> Post([FromBody] ExportPermitActualAmendmentReportRequest? request)
        {
        ...
        [HttpPost("Excel")]
        public async Task<IActionResult> Excel([FromBody] ExportPermitActualAmendmentReportRequest? request)
        {
        ...
        public string ExcelWorksheetTitle => "Export Permit Actual Amendment Report";
        public Type ExcelRequestType => typeof(ExportPermitActualAmendmentReportRequest);

        [NonAction]
        public Task WriteRowsAsync(object request, IExcelRowSink sink, int chunkSize, CancellationToken cancellationToken)
            => WriteRowsAsync((ExportPermitActualAmendmentReportRequest)request, sink, chunkSize, cancellationToken);

        private async Task WriteRowsAsync(
            ExportPermitActualAmendmentReportRequest request,
            IExcelRowSink sink,
            int chunkSize,
    ...
    public sealed class ExportPermitActualAmendmentReportRequest : ReportQueryRequest
    {
