...
namespace Backend.Controllers.Report
{
    ...
    public class ExportPermitActualAmendmentReportController : ControllerBase
    {
        ...
        public ExportPermitActualAmendmentReportController(TradeNetDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Excel([FromBody] ExportPermitActualAmendmentReportRequest? request)
        {
            ...
            var data = rows.Select(row => row.ToResult()).ToList();
            var fileBytes = ExcelGenerator.CreateWorkbook(data, "Export Permit Actual Amendment Report");

            return File(fileBytes, ExcelGenerator.ContentType, "ExportPermitActualAmendmentReport.xlsx");
        }
