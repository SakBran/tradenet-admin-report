...
namespace Backend.Controllers.Report
{
    ...
    public class BorderExportPermitCancellationReportController : ControllerBase
    {
        private readonly TradeNetDbContext _context;

        public BorderExportPermitCancellationReportController(TradeNetDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Excel([FromBody] BorderExportPermitCancellationReportRequest? request)
        {
            ...
            try
            {
                fileBytes = await ExcelGenerator.CreateWorkbookAsync(
                    query,
                    request!,
                    "Border Export Permit Cancellation Report");
            }
            ...
            return File(
                ...
                "BorderExportPermitCancellationReport.xlsx");
        }
