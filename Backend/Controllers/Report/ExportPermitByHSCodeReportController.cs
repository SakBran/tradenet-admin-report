...
namespace Backend.Controllers.Report
{
    ...
    public class ExportPermitByHSCodeReportController : ControllerBase
    {
        private readonly TradeNetDbContext _context;

        public ExportPermitByHSCodeReportController(TradeNetDbContext context)
        {
            _context = context;
        }

        [HttpPost]
        public async Task<ActionResult<ApiResult<sp_HSCodeReportResult>>> Post([FromBody] ExportPermitByHSCodeReportRequest? request)
        {
        ...
        public async Task<IActionResult> Excel([FromBody] ExportPermitByHSCodeReportRequest? request)
        {
            ...
            try
            {
                fileBytes = await ExcelGenerator.CreateWorkbookAsync(
                    query,
                    request!,
                    "Export Permit By HS Code Report");
            }
            ...
            return File(
                ...
                "ExportPermitByHSCodeReport.xlsx");
        }
