...
namespace Backend.Controllers.Report
{
    ...
    public class BorderImportLicenceAmendmentReportController : ControllerBase, IStreamingExcelReport
    {
        private const string ReportKey = "BorderImportLicenceAmendmentReport";
        ...
        public BorderImportLicenceAmendmentReportController(TradeNetDbContext context, IExcelExportJobService excelExportJobs)
        {
            _context = context;
        ...
        [HttpPost]
        public async Task<ActionResult<ApiResult<sp_AmendReportResult>>> Post([FromBody] BorderImportLicenceAmendmentReportRequest? request)
        {
        ...
        [HttpPost("Excel")]
        public async Task<IActionResult> Excel([FromBody] BorderImportLicenceAmendmentReportRequest? request)
        {
        ...
        public string ExcelWorksheetTitle => "Border Import Licence Amendment Report";
        public Type ExcelRequestType => typeof(BorderImportLicenceAmendmentReportRequest);

        [NonAction]
        public Task WriteRowsAsync(object request, IExcelRowSink sink, int chunkSize, CancellationToken cancellationToken)
            => WriteRowsAsync((BorderImportLicenceAmendmentReportRequest)request, sink, chunkSize, cancellationToken);

        private async Task WriteRowsAsync(
            BorderImportLicenceAmendmentReportRequest request,
            IExcelRowSink sink,
            int chunkSize,
    ...
    public sealed class BorderImportLicenceAmendmentReportRequest : ReportQueryRequest
    {
