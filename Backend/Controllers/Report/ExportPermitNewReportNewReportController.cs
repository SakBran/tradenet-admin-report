...
namespace Backend.Controllers.Report
{
    ...
    public class ExportPermitNewReportNewReportController : ControllerBase, IStreamingExcelReport
    {
        ...
        public ExportPermitNewReportNewReportController(TradeNetDbContext context, IExcelExportJobService excelExportJobs)
        {
            _context = context;
        ...
        [HttpPost]
        public async Task<ActionResult<ApiResult<sp_NewReportResult>>> Post([FromBody] ExportPermitNewReportNewReportRequest? request)
        {
        ...
        [HttpPost("Excel")]
        public async Task<IActionResult> Excel([FromBody] ExportPermitNewReportNewReportRequest? request)
        {
        ...
        public string ExcelWorksheetTitle => "Export Permit New Report (New Report )";
        public Type ExcelRequestType => typeof(ExportPermitNewReportNewReportRequest);

        [NonAction]
        public Task WriteRowsAsync(object request, IExcelRowSink sink, int chunkSize, CancellationToken cancellationToken)
            => WriteRowsAsync((ExportPermitNewReportNewReportRequest)request, sink, chunkSize, cancellationToken);

        private async Task WriteRowsAsync(
            ExportPermitNewReportNewReportRequest request,
            IExcelRowSink sink,
            int chunkSize,
    ...
    public sealed class ExportPermitNewReportNewReportRequest : ReportQueryRequest
    {
