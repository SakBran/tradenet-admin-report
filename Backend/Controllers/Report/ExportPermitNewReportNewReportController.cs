...
namespace Backend.Controllers.Report
{
    ...
    public class ExportPermitNewReportNewReportController : ControllerBase
    {
        ...
        public ExportPermitNewReportNewReportController(TradeNetDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Excel([FromBody] ExportPermitNewReportNewReportRequest? request)
        {
            ...
            var data = rows.Select(row => row.ToResult()).ToList();
            var fileBytes = ExcelGenerator.CreateWorkbook(data, "Export Permit New Report (New Report )");

            return File(fileBytes, ExcelGenerator.ContentType, "ExportPermitNewReportNewReport.xlsx");
        }
