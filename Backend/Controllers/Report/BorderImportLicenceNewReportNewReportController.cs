...
namespace Backend.Controllers.Report
{
    ...
    public class BorderImportLicenceNewReportNewReportController : ControllerBase, IStreamingExcelReport
    {
        private const string ReportKey = "BorderImportLicenceNewReportNewReport";
        ...
        public BorderImportLicenceNewReportNewReportController(TradeNetDbContext context, IExcelExportJobService excelExportJobs)
        {
            _context = context;
        ...
        public string ExcelWorksheetTitle => "Border Import Licence New Report (New Report )";
        public Type ExcelRequestType => typeof(BorderImportLicenceNewReportNewReportRequest);

        [NonAction]
        public Task WriteRowsAsync(object request, IExcelRowSink sink, int chunkSize, CancellationToken cancellationToken)
            => WriteRowsAsync((BorderImportLicenceNewReportNewReportRequest)request, sink, chunkSize, cancellationToken);
