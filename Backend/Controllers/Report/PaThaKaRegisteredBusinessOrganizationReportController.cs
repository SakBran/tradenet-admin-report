...
namespace Backend.Controllers.Report
{
    ...
    public class PaThaKaRegisteredBusinessOrganizationReportController : ControllerBase, IStreamingExcelReport
    {
        private const string ReportKey = "PaThaKaRegisteredBusinessOrganizationReport";
        ...
        public PaThaKaRegisteredBusinessOrganizationReportController(TradeNetDbContext context, IExcelExportJobService excelExportJobs)
        {
            _context = context;
        ...
        public Task WriteRowsAsync(object request, IExcelRowSink sink, int chunkSize, CancellationToken cancellationToken)
            => WriteRowsAsync((PaThaKaRegisteredBusinessOrganizationReportRequest)request, sink, chunkSize, cancellationToken);

        private async Task WriteRowsAsync(
            PaThaKaRegisteredBusinessOrganizationReportRequest request,
            IExcelRowSink sink,
            int chunkSize,
    ...
    public sealed class PaThaKaRegisteredBusinessOrganizationReportRequest : ReportQueryRequest
    {
