...
namespace Backend.Controllers.Report
{
    ...
    public class EIRCardBindReportController : ControllerBase, IStreamingExcelReport
    {
        private const string ReportKey = "EIRCardBindReport";
        ...
        public EIRCardBindReportController(TradeNetDbContext context, IExcelExportJobService excelExportJobs)
        {
            _context = context;
        ...
        public string ExcelWorksheetTitle => "EIR Card bind Report";
        public Type ExcelRequestType => typeof(EIRCardBindReportRequest);

        [NonAction]
        public Task WriteRowsAsync(object request, IExcelRowSink sink, int chunkSize, CancellationToken cancellationToken)
            => WriteRowsAsync((EIRCardBindReportRequest)request, sink, chunkSize, cancellationToken);
            ...
            CancellationToken cancellationToken)
        {
            ...
            await foreach (var chunk in sp_PathakaBindReport.ExecuteQueryable(_context, procedureRequest!)
