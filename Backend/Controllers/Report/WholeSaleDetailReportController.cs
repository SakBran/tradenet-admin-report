...
namespace Backend.Controllers.Report
{
    ...
    public class WholeSaleDetailReportController : ControllerBase, IStreamingExcelReport
    {
        private const string ReportKey = "WholeSaleDetailReport";
        private const string FormType = "Whole Sale";

        private readonly TradeNetDbContext _context;
        private readonly IExcelExportJobService _excelExportJobs;

        public WholeSaleDetailReportController(TradeNetDbContext context, IExcelExportJobService excelExportJobs)
        {
            _context = context;
        ...
        public string ExcelWorksheetTitle => "Whole Sale Detail Report";
        public Type ExcelRequestType => typeof(WholeSaleDetailReportRequest);

        [NonAction]
        public Task WriteRowsAsync(object request, IExcelRowSink sink, int chunkSize, CancellationToken cancellationToken)
            => WriteRowsAsync((WholeSaleDetailReportRequest)request, sink, chunkSize, cancellationToken);
