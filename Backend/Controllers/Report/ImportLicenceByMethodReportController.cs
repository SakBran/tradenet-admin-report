...
namespace Backend.Controllers.Report
{
        ...
        : ControllerBase, IStreamingExcelReport
    {
        ...
        public ImportLicenceByMethodReportController(TradeNetDbContext context, IExcelExportJobService excelExportJobs)
        {
            _context = context;
        ...
        [HttpPost]
        public async Task<ActionResult<ApiResult<ReportAggregateResult>>> Post([FromBody] ImportLicenceByMethodReportRequest? request)
        {
            ...
            var result = await sp_ImportLicenceDetailReport_Fast.CreateAggregateResultAsync(
                ...
                // summing money across currencies is meaningless (ImportLicenceByMethodReport.rdlc:835/889/943).
        ...
        [HttpPost("Excel")]
        public async Task<IActionResult> Excel([FromBody] ImportLicenceByMethodReportRequest? request)
        {
        ...
        public string ExcelWorksheetTitle => "Import Licence By Method Report";
        public Type ExcelRequestType => typeof(ImportLicenceByMethodReportRequest);

        [NonAction]
        public Task WriteRowsAsync(object request, IExcelRowSink sink, int chunkSize, CancellationToken cancellationToken)
            => WriteRowsAsync((ImportLicenceByMethodReportRequest)request, sink, chunkSize, cancellationToken);

        private async Task WriteRowsAsync(
            ImportLicenceByMethodReportRequest request,
            IExcelRowSink sink,
            int chunkSize,
            CancellationToken cancellationToken)
        {
            ...
            // GROUP BY -- unlike the Export Permit helper it returns the groups unordered.
    ...
    public sealed class ImportLicenceByMethodReportRequest : ReportQueryRequest
    {
