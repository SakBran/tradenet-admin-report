...
namespace Backend.Controllers.Report
{
    ...
    public class ImportLicenceByMethodReportController : ControllerBase
    {
        private readonly TradeNetDbContext _context;
        private readonly IMemoryCache _cache;

        public ImportLicenceByMethodReportController(TradeNetDbContext context, IMemoryCache cache)
        {
            _context = context;
            _cache = cache;
        }
        ...
        [HttpPost]
        public async Task<ActionResult<ApiResult<sp_ImportLicenceDetailReportResult>>> Post([FromBody] ImportLicenceByMethodReportRequest? request)
        {
        ...
        public async Task<IActionResult> Excel([FromBody] ImportLicenceByMethodReportRequest? request)
        {
            ...
            try
            {
                fileBytes = await sp_ImportLicenceDetailReport_Fast.CreateExcelWorkbookAsync(
                    ...
                    procedureRequest!,
                    request!,
                    "Import Licence By Method Report");
            }
            ...
            return File(
                ...
                "ImportLicenceByMethodReport.xlsx");
        }
