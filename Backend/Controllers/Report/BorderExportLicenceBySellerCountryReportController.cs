...
namespace Backend.Controllers.Report
{
    ...
    public class BorderExportLicenceBySellerCountryReportController : ControllerBase, IStreamingExcelReport
    {
        private const string ReportKey = "BorderExportLicenceBySellerCountryReport";

        private readonly TradeNetDbContext _context;
        private readonly IMemoryCache _cache;
        private readonly IExcelExportJobService _excelExportJobs;

        public BorderExportLicenceBySellerCountryReportController(TradeNetDbContext context, IMemoryCache cache, IExcelExportJobService excelExportJobs)
        {
            _context = context;
            _cache = cache;
        ...
        [HttpPost]
        public async Task<ActionResult<ApiResult<ReportAggregateResult>>> Post([FromBody] BorderExportLicenceBySellerCountryReportRequest? request)
        {
        ...
        [HttpPost("Excel")]
        public async Task<IActionResult> Excel([FromBody] BorderExportLicenceBySellerCountryReportRequest? request)
        {
        ...
        public Task WriteRowsAsync(object request, IExcelRowSink sink, int chunkSize, CancellationToken cancellationToken)
            => WriteRowsAsync((BorderExportLicenceBySellerCountryReportRequest)request, sink, chunkSize, cancellationToken);

        private async Task WriteRowsAsync(
            BorderExportLicenceBySellerCountryReportRequest request,
            IExcelRowSink sink,
            int chunkSize,
    ...
    public sealed class BorderExportLicenceBySellerCountryReportRequest : ReportQueryRequest
    {
