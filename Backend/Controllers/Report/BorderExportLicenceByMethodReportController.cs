...
namespace Backend.Controllers.Report
{
    ...
    public class BorderExportLicenceByMethodReportController : ControllerBase
    {
        private readonly TradeNetDbContext _context;
        private readonly IMemoryCache _cache;

        public BorderExportLicenceByMethodReportController(TradeNetDbContext context, IMemoryCache cache)
        {
            _context = context;
            _cache = cache;
        }
        ...
        [HttpPost]
        public async Task<ActionResult<ApiResult<sp_ExportLicenceDetailReportResult>>> Post([FromBody] BorderExportLicenceByMethodReportRequest? request)
        {
        ...
        public async Task<IActionResult> Excel([FromBody] BorderExportLicenceByMethodReportRequest? request)
        {
            ...
            try
            {
                fileBytes = await sp_ExportLicenceDetailReport_Fast.CreateExcelWorkbookAsync(
                    ...
                    procedureRequest!,
                    request!,
                    "Border Export Licence By Method Report");
            }
            ...
            return File(
                ...
                "BorderExportLicenceByMethodReport.xlsx");
        }
