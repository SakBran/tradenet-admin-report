...
namespace Backend.Controllers.Report
{
    ...
    public class BorderImportLicenceActualAmendmentReportController : ControllerBase, IStreamingExcelReport
    {
        ...
        public BorderImportLicenceActualAmendmentReportController(TradeNetDbContext context, IExcelExportJobService excelExportJobs)
        {
            _context = context;
        ...
        public string ExcelWorksheetTitle => "Border Import Licence Actual Amendment Report";
        public Type ExcelRequestType => typeof(BorderImportLicenceActualAmendmentReportRequest);

        [NonAction]
        public Task WriteRowsAsync(object request, IExcelRowSink sink, int chunkSize, CancellationToken cancellationToken)
            => WriteRowsAsync((BorderImportLicenceActualAmendmentReportRequest)request, sink, chunkSize, cancellationToken);
