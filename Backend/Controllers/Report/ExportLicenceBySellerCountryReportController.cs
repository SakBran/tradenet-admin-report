...
namespace Backend.Controllers.Report
{
    ...
    public class ExportLicenceBySellerCountryReportController : ControllerBase
    {
        private readonly TradeNetDbContext _context;
        private readonly IMemoryCache _cache;

        public ExportLicenceBySellerCountryReportController(TradeNetDbContext context, IMemoryCache cache)
        {
            _context = context;
            _cache = cache;
        }
        ...
        [HttpPost]
        public async Task<ActionResult<ApiResult<sp_ExportLicenceDetailReportResult>>> Post([FromBody] ExportLicenceBySellerCountryReportRequest? request)
        {
        ...
        public async Task<IActionResult> Excel([FromBody] ExportLicenceBySellerCountryReportRequest? request)
        {
            ...
            try
            {
                fileBytes = await ExcelGenerator.CreateWorkbookAsync(
                    query,
                    request!,
                    "Export Licence By Seller Country Report");
            }
            ...
            return File(
                ...
                "ExportLicenceBySellerCountryReport.xlsx");
        }
