...
namespace Backend.Controllers.Report
{
    ...
    public class ExportLicenceBySellerCountryReportController : ControllerBase, IStreamingExcelReport
    {
        private const string ReportKey = "ExportLicenceBySellerCountryReport";

        private readonly TradeNetDbContext _context;
        private readonly IExcelExportJobService _excelExportJobs;

        public ExportLicenceBySellerCountryReportController(TradeNetDbContext context, IExcelExportJobService excelExportJobs)
        {
            _context = context;
        ...
        [HttpPost]
        public async Task<ActionResult<ApiResult<ReportAggregateResult>>> Post([FromBody] ExportLicenceBySellerCountryReportRequest? request)
        {
        ...
        [HttpPost("Excel")]
        public async Task<IActionResult> Excel([FromBody] ExportLicenceBySellerCountryReportRequest? request)
        {
        ...
        public Task WriteRowsAsync(object request, IExcelRowSink sink, int chunkSize, CancellationToken cancellationToken)
            => WriteRowsAsync((ExportLicenceBySellerCountryReportRequest)request, sink, chunkSize, cancellationToken);

        private async Task WriteRowsAsync(
            ExportLicenceBySellerCountryReportRequest request,
            IExcelRowSink sink,
            int chunkSize,
    ...
    public sealed class ExportLicenceBySellerCountryReportRequest : ReportQueryRequest
    {
