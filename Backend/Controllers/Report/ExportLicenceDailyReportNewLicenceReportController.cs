...
namespace Backend.Controllers.Report
{
    ...
    public class ExportLicenceDailyReportNewLicenceReportController : ControllerBase
    {
        private readonly TradeNetDbContext _context;
        private readonly IMemoryCache _cache;

        public ExportLicenceDailyReportNewLicenceReportController(TradeNetDbContext context, IMemoryCache cache)
        {
            _context = context;
            _cache = cache;
        }
        ...
        [HttpPost]
        public async Task<ActionResult<ApiResult<sp_ExportLicenceDetailReportResult>>> Post([FromBody] ExportLicenceDailyReportNewLicenceReportRequest? request)
        {
        ...
        public async Task<IActionResult> Excel([FromBody] ExportLicenceDailyReportNewLicenceReportRequest? request)
        {
            ...
            try
            {
                fileBytes = await ExcelGenerator.CreateWorkbookAsync(
                    query,
                    request!,
                    "Export Licence Daily Report (New Licence Report)");
            }
            ...
            return File(
                ...
                "ExportLicenceDailyReportNewLicenceReport.xlsx");
        }
