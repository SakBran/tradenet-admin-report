...
namespace Backend.Controllers.Report
{
    ...
    public class BorderExportLicenceNewReportNewReportController : ControllerBase
    {
        ...
        public BorderExportLicenceNewReportNewReportController(TradeNetDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Excel([FromBody] BorderExportLicenceNewReportNewReportRequest? request)
        {
            ...
            var data = rows.Select(row => row.ToResult()).ToList();
            var fileBytes = ExcelGenerator.CreateWorkbook(data, "Border Export Licence New Report (New Report )");

            return File(fileBytes, ExcelGenerator.ContentType, "BorderExportLicenceNewReportNewReport.xlsx");
        }
