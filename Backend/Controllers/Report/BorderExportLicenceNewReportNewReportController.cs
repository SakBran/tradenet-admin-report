...
namespace Backend.Controllers.Report
{
    ...
    public class BorderExportLicenceNewReportNewReportController : ControllerBase, IStreamingExcelReport
    {
        private const string ReportKey = "BorderExportLicenceNewReportNewReport";
        ...
        public BorderExportLicenceNewReportNewReportController(TradeNetDbContext context, IExcelExportJobService excelExportJobs)
        {
            _context = context;
        ...
        [HttpPost]
        public async Task<ActionResult<ApiResult<sp_NewReportResult>>> Post([FromBody] BorderExportLicenceNewReportNewReportRequest? request)
        {
            ...
            if (data.Count > 0)
            {
                result.CurrencyTotals = await ExportLicenceListingCurrencyTotals.ExecuteAsync(
                    _context, procedureRequest!.FormType, "New", procedureRequest.FromDate, procedureRequest.ToDate,
        ...
        [HttpPost("Excel")]
        public async Task<IActionResult> Excel([FromBody] BorderExportLicenceNewReportNewReportRequest? request)
        {
        ...
        public string ExcelWorksheetTitle => "Border Export Licence New Report (New Report )";
        public Type ExcelRequestType => typeof(BorderExportLicenceNewReportNewReportRequest);

        [NonAction]
        public Task WriteRowsAsync(object request, IExcelRowSink sink, int chunkSize, CancellationToken cancellationToken)
            => WriteRowsAsync((BorderExportLicenceNewReportNewReportRequest)request, sink, chunkSize, cancellationToken);

        private async Task WriteRowsAsync(
            BorderExportLicenceNewReportNewReportRequest request,
            IExcelRowSink sink,
            int chunkSize,
    ...
    public sealed class BorderExportLicenceNewReportNewReportRequest : ReportQueryRequest
    {
