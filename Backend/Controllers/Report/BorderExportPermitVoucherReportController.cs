...
namespace Backend.Controllers.Report
{
    ...
    public class BorderExportPermitVoucherReportController : ControllerBase, IStreamingExcelReport
    {
        ...
        public BorderExportPermitVoucherReportController(TradeNetDbContext context, IExcelExportJobService excelExportJobs)
        {
            _context = context;
        ...
        [HttpPost]
        public async Task<ActionResult<ApiResult<sp_VoucherReportResult>>> Post([FromBody] BorderExportPermitVoucherReportRequest? request)
        {
        ...
        [HttpPost("Excel")]
        public async Task<IActionResult> Excel([FromBody] BorderExportPermitVoucherReportRequest? request)
        {
        ...
        public string ExcelWorksheetTitle => "Border Export Permit Voucher Report";
        public Type ExcelRequestType => typeof(BorderExportPermitVoucherReportRequest);

        [NonAction]
        public Task WriteRowsAsync(object request, IExcelRowSink sink, int chunkSize, CancellationToken cancellationToken)
            => WriteRowsAsync((BorderExportPermitVoucherReportRequest)request, sink, chunkSize, cancellationToken);

        private async Task WriteRowsAsync(
            BorderExportPermitVoucherReportRequest request,
            IExcelRowSink sink,
            int chunkSize,
            ...
            out ActionResult? errorResult)
        {
            ...
            procedureRequest = new sp_VoucherReportRequest
            {
                ...
                ApplyType = string.IsNullOrWhiteSpace(request.ApplyType) ? "New" : request.ApplyType,
    ...
    public sealed class BorderExportPermitVoucherReportRequest : ReportQueryRequest
    {
