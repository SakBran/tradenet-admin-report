...
namespace Backend.Controllers.Report
{
    ...
    public class RegistrationByVoucherController : ControllerBase, IStreamingExcelReport
    {
        private const string ReportKey = "RegistrationByVoucher";
        ...
        public RegistrationByVoucherController(TradeNetDbContext context, IExcelExportJobService excelExportJobs)
        {
            _context = context;
        ...
        public string ExcelWorksheetTitle => "Registration By Voucher";
        public Type ExcelRequestType => typeof(RegistrationByVoucherRequest);

        [NonAction]
        public Task WriteRowsAsync(object request, IExcelRowSink sink, int chunkSize, CancellationToken cancellationToken)
            => WriteRowsAsync((RegistrationByVoucherRequest)request, sink, chunkSize, cancellationToken);
            ...
            CancellationToken cancellationToken)
        {
            ...
            await foreach (var chunk in sp_PaThaKaRegistrationReport.ExecuteQueryable(_context, procedureRequest!)
