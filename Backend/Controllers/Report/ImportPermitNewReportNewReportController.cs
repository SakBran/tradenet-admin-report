...
namespace Backend.Controllers.Report
{
    ...
    public class ImportPermitNewReportNewReportController : ControllerBase
    {
        ...
        public ImportPermitNewReportNewReportController(TradeNetDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Excel([FromBody] ImportPermitNewReportNewReportRequest? request)
        {
            ...
            var data = rows.Select(row => row.ToResult()).ToList();
            var fileBytes = ExcelGenerator.CreateWorkbook(data, "Import Permit New Report (New Report )");

            return File(fileBytes, ExcelGenerator.ContentType, "ImportPermitNewReportNewReport.xlsx");
        }
