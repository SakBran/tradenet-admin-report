...
namespace Backend.Controllers.Report
{
    ...
    public class BorderImportPermitDetailReportController : ControllerBase
    {
        private readonly TradeNetDbContext _context;
        private readonly IMemoryCache _cache;

        public BorderImportPermitDetailReportController(TradeNetDbContext context, IMemoryCache cache)
        {
            _context = context;
            _cache = cache;
        }
        ...
        public async Task<IActionResult> Excel([FromBody] BorderImportPermitDetailReportRequest? request)
        {
            ...
            try
            {
                fileBytes = await sp_ImportPermitDetailReport_Fast.CreateExcelWorkbookAsync(
                    _context, _cache, procedureRequest!, request!, "Border Import Permit Detail Report");
            }
            ...
            return File(
                ...
                "BorderImportPermitDetailReport.xlsx");
        }
