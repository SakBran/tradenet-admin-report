...
namespace Backend.Controllers.Report
{
    ...
    public class BorderExportLicenceBySectionReportController : ControllerBase
    {
        private readonly TradeNetDbContext _context;
        private readonly IMemoryCache _cache;

        public BorderExportLicenceBySectionReportController(TradeNetDbContext context, IMemoryCache cache)
        {
            _context = context;
            _cache = cache;
        }
        ...
        public async Task<IActionResult> Excel([FromBody] BorderExportLicenceBySectionReportRequest? request)
        {
            ...
            return File(
                ...
                "BorderExportLicenceBySectionReport.xlsx");
        }
