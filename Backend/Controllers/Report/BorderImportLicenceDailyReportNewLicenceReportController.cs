...
namespace Backend.Controllers.Report
{
    ...
    public class BorderImportLicenceDailyReportNewLicenceReportController : ControllerBase
    {
        private readonly TradeNetDbContext _context;
        private readonly IMemoryCache _cache;

        public BorderImportLicenceDailyReportNewLicenceReportController(TradeNetDbContext context, IMemoryCache cache)
        {
            _context = context;
            _cache = cache;
        }
        ...
        [HttpPost]
        public async Task<ActionResult<ApiResult<sp_ImportLicenceDetailReportResult>>> Post([FromBody] BorderImportLicenceDailyReportNewLicenceReportRequest? request)
        {
        ...
        public async Task<IActionResult> Excel([FromBody] BorderImportLicenceDailyReportNewLicenceReportRequest? request)
        {
            ...
            try
            {
                fileBytes = await sp_ImportLicenceDetailReport_Fast.CreateExcelWorkbookAsync(
                    ...
                    procedureRequest!,
                    request!,
                    "Border Import Licence Daily Report (New Licence Report)");
            }
            ...
            return File(
                ...
                "BorderImportLicenceDailyReportNewLicenceReport.xlsx");
        }
