...
namespace Backend.Controllers.Report
{
    ...
    public class BorderImportPermitNewReportNewReportController : ControllerBase
    {
        private readonly TradeNetDbContext _context;

        public BorderImportPermitNewReportNewReportController(TradeNetDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Excel([FromBody] BorderImportPermitNewReportNewReportRequest? request)
        {
            ...
            return File(
                ...
                "BorderImportPermitNewReportNewReport.xlsx");
        }
