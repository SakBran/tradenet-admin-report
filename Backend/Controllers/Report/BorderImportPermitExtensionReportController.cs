...
namespace Backend.Controllers.Report
{
    ...
    public class BorderImportPermitExtensionReportController : ControllerBase
    {
        private readonly TradeNetDbContext _context;

        public BorderImportPermitExtensionReportController(TradeNetDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Excel([FromBody] BorderImportPermitExtensionReportRequest? request)
        {
            ...
            try
            {
                fileBytes = await ExcelGenerator.CreateWorkbookAsync(
                    query,
                    request!,
                    "Border Import Permit Extension Report");
            }
            ...
            return File(
                ...
                "BorderImportPermitExtensionReport.xlsx");
        }
