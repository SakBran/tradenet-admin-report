...
namespace Backend.Controllers.Report
{
    ...
    public class DutyFreeShopSummaryReportController : ControllerBase
    {
        private readonly TradeNetDbContext _context;

        public DutyFreeShopSummaryReportController(TradeNetDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Excel([FromBody] DutyFreeShopSummaryReportRequest? request)
        {
            ...
            return File(
                ...
                "DutyFreeShopSummaryReport.xlsx");
        }
