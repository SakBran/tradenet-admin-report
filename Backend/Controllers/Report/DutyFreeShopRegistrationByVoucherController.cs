...
namespace Backend.Controllers.Report
{
    ...
    public class DutyFreeShopRegistrationByVoucherController : ControllerBase, IStreamingExcelReport
    {
        private const string ReportKey = "DutyFreeShopRegistrationByVoucher";

        private readonly TradeNetDbContext _context;
        private readonly IExcelExportJobService _excelExportJobs;

        public DutyFreeShopRegistrationByVoucherController(TradeNetDbContext context, IExcelExportJobService excelExportJobs)
        {
            _context = context;
        ...
        public string ExcelWorksheetTitle => "Duty Free Shop Registration By Voucher";
        public Type ExcelRequestType => typeof(DutyFreeShopRegistrationByVoucherRequest);

        [NonAction]
        public Task WriteRowsAsync(object request, IExcelRowSink sink, int chunkSize, CancellationToken cancellationToken)
            => WriteRowsAsync((DutyFreeShopRegistrationByVoucherRequest)request, sink, chunkSize, cancellationToken);
            ...
            CancellationToken cancellationToken)
        {
            ...
            var query = sp_DutyFreeShopRegistrationReport.Query(_context, procedureRequest!);
