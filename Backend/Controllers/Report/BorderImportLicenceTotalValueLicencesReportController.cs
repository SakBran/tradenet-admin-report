...
namespace Backend.Controllers.Report
{
    ...
    public class BorderImportLicenceTotalValueLicencesReportController
        : ControllerBase, IStreamingExcelReport, IExcelReportLayoutProvider
    {
        private const string ReportKey = "BorderImportLicenceTotalValueLicencesReport";

        private readonly TradeNetDbContext _context;
        private readonly IMemoryCache _cache;
        private readonly IExcelExportJobService _excelExportJobs;

        public BorderImportLicenceTotalValueLicencesReportController(TradeNetDbContext context, IMemoryCache cache, IExcelExportJobService excelExportJobs)
        {
            _context = context;
            _cache = cache;
        ...
        [HttpPost]
        public async Task<ActionResult<ImportLicenceTotalValueLicencesSummary>> Post([FromBody] BorderImportLicenceTotalValueLicencesReportRequest? request)
        {
            ...
            var result = await sp_ImportLicenceDetailReport_Fast.GetTotalValueLicencesSummaryAsync(
        ...
        [HttpPost("Excel")]
        public async Task<IActionResult> Excel([FromBody] BorderImportLicenceTotalValueLicencesReportRequest? request)
        {
        ...
        public string ExcelWorksheetTitle => "Border Import Licence Total Value & Licences Report";
        public Type ExcelRequestType => typeof(BorderImportLicenceTotalValueLicencesReportRequest);
        ...
        /// (Frontend/src/Report/Page/BorderImportLicenceTotalValueLicencesReport.tsx —
        ...
        {
            var typedRequest = (BorderImportLicenceTotalValueLicencesReportRequest)request;
        ...
        public Task WriteRowsAsync(object request, IExcelRowSink sink, int chunkSize, CancellationToken cancellationToken)
            => WriteRowsAsync((BorderImportLicenceTotalValueLicencesReportRequest)request, sink, chunkSize, cancellationToken);

        private async Task WriteRowsAsync(
            BorderImportLicenceTotalValueLicencesReportRequest request,
            IExcelRowSink sink,
            int chunkSize,
    ...
    public sealed class BorderImportLicenceTotalValueLicencesReportRequest : ReportQueryRequest
    {
