...
namespace Backend.Controllers.Report
{
    ...
    public class BorderExportPermitNewReportNewReportController : ControllerBase, IStreamingExcelReport
    {
        ...
        public BorderExportPermitNewReportNewReportController(TradeNetDbContext context, IExcelExportJobService excelExportJobs)
        {
            _context = context;
        ...
        [HttpPost]
        public async Task<ActionResult<ApiResult<sp_NewReportResult>>> Post([FromBody] BorderExportPermitNewReportNewReportRequest? request)
        {
        ...
        [HttpPost("Excel")]
        public async Task<IActionResult> Excel([FromBody] BorderExportPermitNewReportNewReportRequest? request)
        {
        ...
        public string ExcelWorksheetTitle => "Border Export Permit New Report (New Report )";
        public Type ExcelRequestType => typeof(BorderExportPermitNewReportNewReportRequest);

        [NonAction]
        public Task WriteRowsAsync(object request, IExcelRowSink sink, int chunkSize, CancellationToken cancellationToken)
            => WriteRowsAsync((BorderExportPermitNewReportNewReportRequest)request, sink, chunkSize, cancellationToken);

        private async Task WriteRowsAsync(
            BorderExportPermitNewReportNewReportRequest request,
            IExcelRowSink sink,
            int chunkSize,
    ...
    public sealed class BorderExportPermitNewReportNewReportRequest : ReportQueryRequest
    {
