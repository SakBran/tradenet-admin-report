...
namespace Backend.Controllers.Report
{
    ...
    public class ImportPermitDailyReportNewPermitReportController : ControllerBase, IStreamingExcelReport
    {
        private const string ReportKey = "ImportPermitDailyReportNewPermitReport";

        private readonly TradeNetDbContext _context;
        private readonly IExcelExportJobService _excelExportJobs;

        public ImportPermitDailyReportNewPermitReportController(TradeNetDbContext context, IExcelExportJobService excelExportJobs)
        {
            _context = context;
        ...
        [HttpPost]
        public async Task<ActionResult<ApiResult<ReportAggregateResult>>> Post([FromBody] ImportPermitDailyReportNewPermitReportRequest? request)
        {
            ...
            var result = await sp_ImportPermitDetailReport_Fast.CreateAggregateResultAsync(
                ...
                // across currencies is meaningless (ImportPermitByDailyReport.rdlc:985/1039/1200).
        ...
        [HttpPost("Excel")]
        public async Task<IActionResult> Excel([FromBody] ImportPermitDailyReportNewPermitReportRequest? request)
        {
        ...
        public string ExcelWorksheetTitle => "Import Permit Daily Report (New Permit Report)";
        public Type ExcelRequestType => typeof(ImportPermitDailyReportNewPermitReportRequest);

        [NonAction]
        public Task WriteRowsAsync(object request, IExcelRowSink sink, int chunkSize, CancellationToken cancellationToken)
            => WriteRowsAsync((ImportPermitDailyReportNewPermitReportRequest)request, sink, chunkSize, cancellationToken);

        private async Task WriteRowsAsync(
            ImportPermitDailyReportNewPermitReportRequest request,
            IExcelRowSink sink,
            int chunkSize,
    ...
    public sealed class ImportPermitDailyReportNewPermitReportRequest : ReportQueryRequest
    {
