...
namespace Backend.Controllers.Report
{
    ...
    public class EVShowRoomSummaryReportController : ControllerBase, IStreamingExcelReport
    {
        ...
        public EVShowRoomSummaryReportController(TradeNetDbContext context, IExcelExportJobService excelExportJobs)
        {
            _context = context;
        ...
        public string ExcelWorksheetTitle => "EV Show Room Summary Report";
        public Type ExcelRequestType => typeof(EVShowRoomSummaryReportRequest);

        [NonAction]
        public Task WriteRowsAsync(object request, IExcelRowSink sink, int chunkSize, CancellationToken cancellationToken)
            => WriteRowsAsync((EVShowRoomSummaryReportRequest)request, sink, chunkSize, cancellationToken);
