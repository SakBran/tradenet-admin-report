...
namespace Backend.Controllers.Report
{
    ...
    public class ImportPermitCompanyListReportController : ControllerBase
    {
        ...
        public ImportPermitCompanyListReportController(TradeNetDbContext context)
        {
            _context = context;
        }

        [HttpPost]
        public async Task<ActionResult<ApiResult<sp_ImportPermitDetailReportResult>>> Post([FromBody] ImportPermitCompanyListReportRequest? request)
        {
        ...
        public async Task<IActionResult> Excel([FromBody] ImportPermitCompanyListReportRequest? request)
        {
            ...
            try
            {
                fileBytes = await ExcelGenerator.CreateWorkbookAsync(
                    query,
                    request!,
                    "Import Permit Company List Report");
            }
