...
namespace Backend.Controllers.Report
{
    ...
    public class BorderExportLicenceExtensionReportController : ControllerBase
    {
        ...
        public BorderExportLicenceExtensionReportController(TradeNetDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Excel([FromBody] BorderExportLicenceExtensionReportRequest? request)
        {
            ...
            var data = rows.Select(row => row.ToResult()).ToList();
            var fileBytes = ExcelGenerator.CreateWorkbook(data, "Border Export Licence Extension Report");

            return File(fileBytes, ExcelGenerator.ContentType, "BorderExportLicenceExtensionReport.xlsx");
        }
