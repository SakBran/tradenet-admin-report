...
namespace Backend.Controllers.Report
{
    ...
    public class BorderExportLicenceExtensionReportController : ControllerBase, IStreamingExcelReport
    {
        private const string ReportKey = "BorderExportLicenceExtensionReport";
        ...
        public BorderExportLicenceExtensionReportController(TradeNetDbContext context, IExcelExportJobService excelExportJobs)
        {
            _context = context;
        ...
        [HttpPost]
        public async Task<ActionResult<ApiResult<sp_ExtensionReportResult>>> Post([FromBody] BorderExportLicenceExtensionReportRequest? request)
        {
        ...
        [HttpPost("Excel")]
        public async Task<IActionResult> Excel([FromBody] BorderExportLicenceExtensionReportRequest? request)
        {
        ...
        public string ExcelWorksheetTitle => "Border Export Licence Extension Report";
        public Type ExcelRequestType => typeof(BorderExportLicenceExtensionReportRequest);

        [NonAction]
        public Task WriteRowsAsync(object request, IExcelRowSink sink, int chunkSize, CancellationToken cancellationToken)
            => WriteRowsAsync((BorderExportLicenceExtensionReportRequest)request, sink, chunkSize, cancellationToken);

        private async Task WriteRowsAsync(
            BorderExportLicenceExtensionReportRequest request,
            IExcelRowSink sink,
            int chunkSize,
    ...
    public sealed class BorderExportLicenceExtensionReportRequest : ReportQueryRequest
    {
