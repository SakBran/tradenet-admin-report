...
namespace Backend.Controllers.Report
{
    ...
    public class BorderImportPermitByHSCodeReportController : ControllerBase
    {
        private readonly TradeNetDbContext _context;

        public BorderImportPermitByHSCodeReportController(TradeNetDbContext context)
        {
            _context = context;
        }

        [HttpPost]
        public async Task<ActionResult<ApiResult<sp_HSCodeReportResult>>> Post([FromBody] BorderImportPermitByHSCodeReportRequest? request)
        {
        ...
        public async Task<IActionResult> Excel([FromBody] BorderImportPermitByHSCodeReportRequest? request)
        {
            ...
            return File(
                ...
                "BorderImportPermitByHSCodeReport.xlsx");
        }
