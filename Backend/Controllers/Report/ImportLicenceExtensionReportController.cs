...
namespace Backend.Controllers.Report
{
    ...
    public class ImportLicenceExtensionReportController : ControllerBase
    {
        ...
        public ImportLicenceExtensionReportController(TradeNetDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Excel([FromBody] ImportLicenceExtensionReportRequest? request)
        {
            ...
            var data = rows.Select(row => row.ToResult()).ToList();
            var fileBytes = ExcelGenerator.CreateWorkbook(data, "Import Licence Extension Report");

            return File(fileBytes, ExcelGenerator.ContentType, "ImportLicenceExtensionReport.xlsx");
        }
