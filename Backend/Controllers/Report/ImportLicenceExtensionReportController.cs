...
namespace Backend.Controllers.Report
{
    ...
    public class ImportLicenceExtensionReportController : ControllerBase, IStreamingExcelReport
    {
        private const string ReportKey = "ImportLicenceExtensionReport";
        ...
        public ImportLicenceExtensionReportController(TradeNetDbContext context, IExcelExportJobService excelExportJobs)
        {
            _context = context;
        ...
        [HttpPost]
        public async Task<ActionResult<ApiResult<sp_ExtensionReportResult>>> Post([FromBody] ImportLicenceExtensionReportRequest? request)
        {
        ...
        [HttpPost("Excel")]
        public async Task<IActionResult> Excel([FromBody] ImportLicenceExtensionReportRequest? request)
        {
        ...
        public string ExcelWorksheetTitle => "Import Licence Extension Report";
        public Type ExcelRequestType => typeof(ImportLicenceExtensionReportRequest);

        [NonAction]
        public Task WriteRowsAsync(object request, IExcelRowSink sink, int chunkSize, CancellationToken cancellationToken)
            => WriteRowsAsync((ImportLicenceExtensionReportRequest)request, sink, chunkSize, cancellationToken);

        private async Task WriteRowsAsync(
            ImportLicenceExtensionReportRequest request,
            IExcelRowSink sink,
            int chunkSize,
    ...
    public sealed class ImportLicenceExtensionReportRequest : ReportQueryRequest
    {
