...
namespace Backend.Controllers.Report
{
    ...
    public class ImportPermitBySectionReportController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<ActionResult<ApiResult<sp_ImportPermitDetailReportResult>>> Post([FromBody] ImportPermitBySectionReportRequest? request)
        {
        ...
        public async Task<IActionResult> Excel([FromBody] ImportPermitBySectionReportRequest? request)
        {
            ...
            try
            {
                fileBytes = await sp_ImportPermitDetailReport_Fast.CreateExcelWorkbookAsync(
                    _context, _cache, procedureRequest!, request!, "Import Permit By Section Report");
            }
            ...
            return File(
                ...
                "ImportPermitBySectionReport.xlsx");
        }
