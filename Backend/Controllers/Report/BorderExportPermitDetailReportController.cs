...
namespace Backend.Controllers.Report
{
    ...
    public class BorderExportPermitDetailReportController : ControllerBase
    {
        private readonly TradeNetDbContext _context;
        private readonly IMemoryCache _cache;

        public BorderExportPermitDetailReportController(TradeNetDbContext context, IMemoryCache cache)
        {
            _context = context;
            _cache = cache;
        }
        ...
        public async Task<IActionResult> Excel([FromBody] BorderExportPermitDetailReportRequest? request)
        {
            ...
            try
            {
                fileBytes = await sp_ExportPermitDetailReport_Fast.CreateExcelWorkbookAsync(_context, _cache, procedureRequest!, request!, "Border Export Permit Detail Report");
            }
            ...
            return File(
                ...
                "BorderExportPermitDetailReport.xlsx");
        }
