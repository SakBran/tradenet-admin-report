...
namespace Backend.Controllers.Report
{
    ...
    public class BorderImportPermitBySectionReportController : ControllerBase
    {
        ...
        public BorderImportPermitBySectionReportController(TradeNetDbContext context)
        {
            _context = context;
        }

        [HttpPost]
        public async Task<ActionResult<ApiResult<sp_ImportPermitDetailReportResult>>> Post([FromBody] BorderImportPermitBySectionReportRequest? request)
        {
