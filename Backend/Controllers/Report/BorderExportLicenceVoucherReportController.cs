...
namespace Backend.Controllers.Report
{
    ...
    public class BorderExportLicenceVoucherReportController : ControllerBase
    {
        ...
        public BorderExportLicenceVoucherReportController(TradeNetDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Excel([FromBody] BorderExportLicenceVoucherReportRequest? request)
        {
            ...
            var data = rows.Select(row => row.ToResult()).ToList();
            var fileBytes = ExcelGenerator.CreateWorkbook(data, "Border Export Licence Voucher Report");

            return File(fileBytes, ExcelGenerator.ContentType, "BorderExportLicenceVoucherReport.xlsx");
        }
