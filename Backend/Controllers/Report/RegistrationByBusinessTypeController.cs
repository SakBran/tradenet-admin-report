...
namespace Backend.Controllers.Report
{
    ...
    public class RegistrationByBusinessTypeController : ControllerBase, IStreamingExcelReport
    {
        private const string ReportKey = "RegistrationByBusinessType";
        ...
        public RegistrationByBusinessTypeController(TradeNetDbContext context, IExcelExportJobService excelExportJobs)
        {
            _context = context;
        ...
        public string ExcelWorksheetTitle => "Registration By Business Type";
        public Type ExcelRequestType => typeof(RegistrationByBusinessTypeRequest);

        [NonAction]
        public Task WriteRowsAsync(object request, IExcelRowSink sink, int chunkSize, CancellationToken cancellationToken)
            => WriteRowsAsync((RegistrationByBusinessTypeRequest)request, sink, chunkSize, cancellationToken);
            ...
            CancellationToken cancellationToken)
        {
            ...
            await foreach (var chunk in sp_PaThaKaByBusinessTypeReport.ExecuteQueryable(_context, procedureRequest!)
