...
namespace Backend.Controllers.Report
{
    ...
    public class ImportLicenceCompanyListReportController : ControllerBase
    {
        private readonly TradeNetDbContext _context;
        private readonly IMemoryCache _cache;

        public ImportLicenceCompanyListReportController(TradeNetDbContext context, IMemoryCache cache)
        {
            _context = context;
            _cache = cache;
        }
        ...
        public async Task<IActionResult> Excel([FromBody] ImportLicenceCompanyListReportRequest? request)
        {
            ...
            return File(
                ...
                "ImportLicenceCompanyListReport.xlsx");
        }
