...
namespace Backend.Controllers.Report
{
    ...
    public class ImportLicenceCompanyListReportController
        : ControllerBase, IStreamingExcelReport
    {
        private const string ReportKey = "ImportLicenceCompanyListReport";

        private readonly TradeNetDbContext _context;
        private readonly IExcelExportJobService _excelExportJobs;

        public ImportLicenceCompanyListReportController(TradeNetDbContext context, IExcelExportJobService excelExportJobs)
        {
            _context = context;
        ...
        public async Task<ActionResult<ApiResult<ReportAggregateResult>>> Post([FromBody] ImportLicenceCompanyListReportRequest? request)
        {
            ...
            var result = await sp_ImportLicenceDetailReport_Fast.CreateAggregateResultAsync(
                ...
                // summing money across currencies is meaningless (ImportLicenceByCompanyReport.rdlc:835/889/943).
        ...
        [HttpPost("Excel")]
        public async Task<IActionResult> Excel([FromBody] ImportLicenceCompanyListReportRequest? request)
        {
        ...
        public string ExcelWorksheetTitle => "Import Licence Company List Report";
        public Type ExcelRequestType => typeof(ImportLicenceCompanyListReportRequest);

        [NonAction]
        public Task WriteRowsAsync(object request, IExcelRowSink sink, int chunkSize, CancellationToken cancellationToken)
            => WriteRowsAsync((ImportLicenceCompanyListReportRequest)request, sink, chunkSize, cancellationToken);

        private async Task WriteRowsAsync(
            ImportLicenceCompanyListReportRequest request,
            IExcelRowSink sink,
            int chunkSize,
    ...
    public sealed class ImportLicenceCompanyListReportRequest : ReportQueryRequest
    {
