...
namespace Backend.Controllers.Report
{
    ...
    public class ExportPermitVoucherReportController : ControllerBase
    {
        ...
        public ExportPermitVoucherReportController(TradeNetDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Excel([FromBody] ExportPermitVoucherReportRequest? request)
        {
            ...
            var data = rows.Select(row => row.ToResult()).ToList();
            var fileBytes = ExcelGenerator.CreateWorkbook(data, "Export Permit Voucher Report");

            return File(fileBytes, ExcelGenerator.ContentType, "ExportPermitVoucherReport.xlsx");
        }
