...
namespace Backend.Controllers.Report
{
    ...
    public class BorderExportLicenceDetailReportController : ControllerBase
    {
        private readonly TradeNetDbContext _context;
        private readonly IMemoryCache _cache;

        public BorderExportLicenceDetailReportController(TradeNetDbContext context, IMemoryCache cache)
        {
            _context = context;
            _cache = cache;
        }
        ...
        public async Task<IActionResult> Excel([FromBody] BorderExportLicenceDetailReportRequest? request)
        {
            ...
            try
            {
                fileBytes = await sp_ExportLicenceDetailReport_Fast.CreateExcelWorkbookAsync(
                    ...
                    procedureRequest!,
                    request!,
                    "Border Export Licence Detail Report");
            }
            ...
            return File(
                ...
                "BorderExportLicenceDetailReport.xlsx");
        }
