...
namespace Backend.Controllers.Report
{
    ...
    public class ExportPermitExtensionReportController : ControllerBase
    {
        ...
        public ExportPermitExtensionReportController(TradeNetDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Excel([FromBody] ExportPermitExtensionReportRequest? request)
        {
            ...
            var data = rows.Select(row => row.ToResult()).ToList();
            var fileBytes = ExcelGenerator.CreateWorkbook(data, "Export Permit Extension Report");

            return File(fileBytes, ExcelGenerator.ContentType, "ExportPermitExtensionReport.xlsx");
        }
