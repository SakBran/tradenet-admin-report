...
namespace Backend.Controllers.Report
{
    ...
    public class ExportPermitExtensionReportController : ControllerBase, IStreamingExcelReport
    {
        private const string ReportKey = "ExportPermitExtensionReport";
        ...
        public ExportPermitExtensionReportController(TradeNetDbContext context, IExcelExportJobService excelExportJobs)
        {
            _context = context;
        ...
        [HttpPost]
        public async Task<ActionResult<ApiResult<sp_ExtensionReportResult>>> Post([FromBody] ExportPermitExtensionReportRequest? request)
        {
        ...
        [HttpPost("Excel")]
        public async Task<IActionResult> Excel([FromBody] ExportPermitExtensionReportRequest? request)
        {
        ...
        public string ExcelWorksheetTitle => "Export Permit Extension Report";
        public Type ExcelRequestType => typeof(ExportPermitExtensionReportRequest);

        [NonAction]
        public Task WriteRowsAsync(object request, IExcelRowSink sink, int chunkSize, CancellationToken cancellationToken)
            => WriteRowsAsync((ExportPermitExtensionReportRequest)request, sink, chunkSize, cancellationToken);

        private async Task WriteRowsAsync(
            ExportPermitExtensionReportRequest request,
            IExcelRowSink sink,
            int chunkSize,
    ...
    public sealed class ExportPermitExtensionReportRequest : ReportQueryRequest
    {
