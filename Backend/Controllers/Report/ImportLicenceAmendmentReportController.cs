...
namespace Backend.Controllers.Report
{
    ...
    public class ImportLicenceAmendmentReportController : ControllerBase, IStreamingExcelReport
    {
        private const string ReportKey = "ImportLicenceAmendmentReport";
        ...
        public ImportLicenceAmendmentReportController(TradeNetDbContext context, IExcelExportJobService excelExportJobs)
        {
            _context = context;
        ...
        [HttpPost]
        public async Task<ActionResult<ApiResult<sp_AmendReportResult>>> Post([FromBody] ImportLicenceAmendmentReportRequest? request)
        {
        ...
        [HttpPost("Excel")]
        public async Task<IActionResult> Excel([FromBody] ImportLicenceAmendmentReportRequest? request)
        {
        ...
        public string ExcelWorksheetTitle => "Import Licence Amendment Report";
        public Type ExcelRequestType => typeof(ImportLicenceAmendmentReportRequest);

        [NonAction]
        public Task WriteRowsAsync(object request, IExcelRowSink sink, int chunkSize, CancellationToken cancellationToken)
            => WriteRowsAsync((ImportLicenceAmendmentReportRequest)request, sink, chunkSize, cancellationToken);

        private async Task WriteRowsAsync(
            ImportLicenceAmendmentReportRequest request,
            IExcelRowSink sink,
            int chunkSize,
    ...
    public sealed class ImportLicenceAmendmentReportRequest : ReportQueryRequest
    {
