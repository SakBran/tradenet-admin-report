...
namespace Backend.Controllers.Report
{
    ...
    public class ImportLicenceAmendmentReportController : ControllerBase
    {
        ...
        public ImportLicenceAmendmentReportController(TradeNetDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Excel([FromBody] ImportLicenceAmendmentReportRequest? request)
        {
            ...
            var data = rows.Select(row => row.ToResult()).ToList();
            var fileBytes = ExcelGenerator.CreateWorkbook(data, "Import Licence Amendment Report");

            return File(
                fileBytes,
                ExcelGenerator.ContentType,
                "ImportLicenceAmendmentReport.xlsx");
        }
