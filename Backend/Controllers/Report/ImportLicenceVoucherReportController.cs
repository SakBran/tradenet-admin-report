...
namespace Backend.Controllers.Report
{
    ...
    public class ImportLicenceVoucherReportController : ControllerBase, IStreamingExcelReport
    {
        ...
        public ImportLicenceVoucherReportController(TradeNetDbContext context, IExcelExportJobService excelExportJobs)
        {
            _context = context;
        ...
        public string ExcelWorksheetTitle => "Import Licence Voucher Report";
        public Type ExcelRequestType => typeof(ImportLicenceVoucherReportRequest);

        [NonAction]
        public Task WriteRowsAsync(object request, IExcelRowSink sink, int chunkSize, CancellationToken cancellationToken)
            => WriteRowsAsync((ImportLicenceVoucherReportRequest)request, sink, chunkSize, cancellationToken);
