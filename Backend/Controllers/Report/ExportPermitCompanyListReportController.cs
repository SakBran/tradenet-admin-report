...
namespace Backend.Controllers.Report
{
    ...
    public class ExportPermitCompanyListReportController : ControllerBase, IStreamingExcelReport
    {
        private const string ReportKey = "ExportPermitCompanyListReport";

        private readonly TradeNetDbContext _context;
        private readonly IExcelExportJobService _excelExportJobs;

        public ExportPermitCompanyListReportController(TradeNetDbContext context, IExcelExportJobService excelExportJobs)
        {
            _context = context;
        ...
        [HttpPost]
        public async Task<ActionResult<ApiResult<ReportAggregateResult>>> Post([FromBody] ExportPermitCompanyListReportRequest? request)
        {
            ...
            var result = await sp_ExportPermitDetailReport_Fast.CreateAggregateResultAsync(
                ...
                // Legacy footer (ExportPermitByCompanyReport.rdlc:885) prints ONLY =CountDistinct(LicenceNo) under
        ...
        [HttpPost("Excel")]
        public async Task<IActionResult> Excel([FromBody] ExportPermitCompanyListReportRequest? request)
        {
        ...
        public string ExcelWorksheetTitle => "Export Permit Company List Report";
        public Type ExcelRequestType => typeof(ExportPermitCompanyListReportRequest);

        [NonAction]
        public Task WriteRowsAsync(object request, IExcelRowSink sink, int chunkSize, CancellationToken cancellationToken)
            => WriteRowsAsync((ExportPermitCompanyListReportRequest)request, sink, chunkSize, cancellationToken);

        private async Task WriteRowsAsync(
            ExportPermitCompanyListReportRequest request,
            IExcelRowSink sink,
            int chunkSize,
    ...
    public sealed class ExportPermitCompanyListReportRequest : ReportQueryRequest
    {
