...
namespace Backend.Controllers.Report
{
    ...
    public class BorderExportLicenceCompanyListReportController : ControllerBase
    {
        private readonly TradeNetDbContext _context;
        private readonly IMemoryCache _cache;

        public BorderExportLicenceCompanyListReportController(TradeNetDbContext context, IMemoryCache cache)
        {
            _context = context;
            _cache = cache;
        }
        ...
        [HttpPost]
        public async Task<ActionResult<ApiResult<sp_ExportLicenceDetailReportResult>>> Post([FromBody] BorderExportLicenceCompanyListReportRequest? request)
        {
        ...
        public async Task<IActionResult> Excel([FromBody] BorderExportLicenceCompanyListReportRequest? request)
        {
            ...
            try
            {
                fileBytes = await sp_ExportLicenceDetailReport_Fast.CreateExcelWorkbookAsync(
                    ...
                    procedureRequest!,
                    request!,
                    "Border Export Licence Company List Report");
            }
            ...
            return File(
                ...
                "BorderExportLicenceCompanyListReport.xlsx");
        }
