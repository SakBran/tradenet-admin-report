...
namespace Backend.Controllers.Report
{
    ...
    public class BorderImportPermitCompanyListReportController : ControllerBase, IStreamingExcelReport
    {
        ...
        public BorderImportPermitCompanyListReportController(TradeNetDbContext context, IMemoryCache cache, IExcelExportJobService excelExportJobs)
        {
            _context = context;
            _cache = cache;
        ...
        [HttpPost]
        public async Task<ActionResult<ApiResult<ReportAggregateResult>>> Post([FromBody] BorderImportPermitCompanyListReportRequest? request)
        {
        ...
        [HttpPost("Excel")]
        public async Task<IActionResult> Excel([FromBody] BorderImportPermitCompanyListReportRequest? request)
        {
        ...
        public string ExcelWorksheetTitle => "Border Import Permit Company List Report";
        public Type ExcelRequestType => typeof(BorderImportPermitCompanyListReportRequest);

        [NonAction]
        public Task WriteRowsAsync(object request, IExcelRowSink sink, int chunkSize, CancellationToken cancellationToken)
            => WriteRowsAsync((BorderImportPermitCompanyListReportRequest)request, sink, chunkSize, cancellationToken);

        private async Task WriteRowsAsync(
            BorderImportPermitCompanyListReportRequest request,
            IExcelRowSink sink,
            int chunkSize,
    ...
    public sealed class BorderImportPermitCompanyListReportRequest : ReportQueryRequest
    {
