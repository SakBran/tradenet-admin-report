...
namespace Backend.Controllers.Report
{
    ...
    public class BorderExportLicenceAmendmentReportController : ControllerBase, IStreamingExcelReport
    {
        private const string ReportKey = "BorderExportLicenceAmendmentReport";
        ...
        public BorderExportLicenceAmendmentReportController(TradeNetDbContext context, IExcelExportJobService excelExportJobs)
        {
            _context = context;
        ...
        [HttpPost]
        public async Task<ActionResult<ApiResult<sp_AmendReportResult>>> Post([FromBody] BorderExportLicenceAmendmentReportRequest? request)
        {
            ...
            if (data.Count > 0)
            {
                result.CurrencyTotals = await ExportLicenceListingCurrencyTotals.ExecuteAsync(
                    _context, procedureRequest!.FormType, "Amend", procedureRequest.FromDate, procedureRequest.ToDate,
        ...
        [HttpPost("Excel")]
        public async Task<IActionResult> Excel([FromBody] BorderExportLicenceAmendmentReportRequest? request)
        {
        ...
        public string ExcelWorksheetTitle => "Border Export Licence Amendment Report";
        public Type ExcelRequestType => typeof(BorderExportLicenceAmendmentReportRequest);

        [NonAction]
        public Task WriteRowsAsync(object request, IExcelRowSink sink, int chunkSize, CancellationToken cancellationToken)
            => WriteRowsAsync((BorderExportLicenceAmendmentReportRequest)request, sink, chunkSize, cancellationToken);

        private async Task WriteRowsAsync(
            BorderExportLicenceAmendmentReportRequest request,
            IExcelRowSink sink,
            int chunkSize,
    ...
    public sealed class BorderExportLicenceAmendmentReportRequest : ReportQueryRequest
    {
