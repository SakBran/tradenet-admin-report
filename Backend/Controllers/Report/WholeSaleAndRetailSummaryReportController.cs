...
namespace Backend.Controllers.Report
{
    ...
    public class WholeSaleAndRetailSummaryReportController : ControllerBase
    {
        private const string FormType = "Whole Sale and Retail";

        private readonly TradeNetDbContext _context;

        public WholeSaleAndRetailSummaryReportController(TradeNetDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Excel([FromBody] WholeSaleAndRetailSummaryReportRequest? request)
        {
            ...
            try
            {
                fileBytes = await ExcelGenerator.CreateWorkbookAsync(
                    query,
                    request!,
                    "Whole Sale and Retail Summary Report");
            }
            ...
            return File(
                ...
                "WholeSaleAndRetailSummaryReport.xlsx");
        }
