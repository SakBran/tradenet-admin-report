...
namespace Backend.Controllers.Report
{
    ...
    public class ExportLicenceTotalValueLicencesReportController : ControllerBase
    {
        private readonly TradeNetDbContext _context;
        private readonly IMemoryCache _cache;

        public ExportLicenceTotalValueLicencesReportController(TradeNetDbContext context, IMemoryCache cache)
        {
            _context = context;
            _cache = cache;
        }
        ...
        [HttpPost]
        public async Task<ActionResult<ApiResult<sp_ExportLicenceDetailReportResult>>> Post([FromBody] ExportLicenceTotalValueLicencesReportRequest? request)
        {
        ...
        public async Task<IActionResult> Excel([FromBody] ExportLicenceTotalValueLicencesReportRequest? request)
        {
            ...
            return File(
                ...
                "ExportLicenceTotalValueLicencesReport.xlsx");
        }
