...
namespace Backend.Controllers.Report
{
    ...
    public class ImportLicenceDailyReportNewLicenceReportController : ControllerBase
    {
        private readonly TradeNetDbContext _context;
        private readonly IMemoryCache _cache;

        public ImportLicenceDailyReportNewLicenceReportController(TradeNetDbContext context, IMemoryCache cache)
        {
            _context = context;
            _cache = cache;
        }
        ...
        public async Task<IActionResult> Excel([FromBody] ImportLicenceDailyReportNewLicenceReportRequest? request)
        {
            ...
            return File(
                ...
                "ImportLicenceDailyReportNewLicenceReport.xlsx");
        }
