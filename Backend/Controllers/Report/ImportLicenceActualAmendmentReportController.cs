...
namespace Backend.Controllers.Report
{
    ...
    public class ImportLicenceActualAmendmentReportController : ControllerBase
    {
        ...
        public ImportLicenceActualAmendmentReportController(TradeNetDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Excel([FromBody] ImportLicenceActualAmendmentReportRequest? request)
        {
            ...
            var data = rows.Select(r => r.ToResult()).ToList();
            var fileBytes = ExcelGenerator.CreateWorkbook(data, "Import Licence Actual Amendment Report");

            return File(fileBytes, ExcelGenerator.ContentType, "ImportLicenceActualAmendmentReport.xlsx");
        }
