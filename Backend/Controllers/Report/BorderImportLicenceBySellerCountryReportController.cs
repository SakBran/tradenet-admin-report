...
namespace Backend.Controllers.Report
{
    ...
    public class BorderImportLicenceBySellerCountryReportController : ControllerBase
    {
        private readonly TradeNetDbContext _context;
        private readonly IMemoryCache _cache;

        public BorderImportLicenceBySellerCountryReportController(TradeNetDbContext context, IMemoryCache cache)
        {
            _context = context;
            _cache = cache;
        }
        ...
        [HttpPost]
        public async Task<ActionResult<ApiResult<sp_ImportLicenceDetailReportResult>>> Post([FromBody] BorderImportLicenceBySellerCountryReportRequest? request)
        {
        ...
        public async Task<IActionResult> Excel([FromBody] BorderImportLicenceBySellerCountryReportRequest? request)
        {
            ...
            return File(
                ...
                "BorderImportLicenceBySellerCountryReport.xlsx");
        }
