...
namespace Backend.Controllers.Report
{
    ...
    public class BorderImportPermitActualAmendmentReportController : ControllerBase
    {
        private readonly TradeNetDbContext _context;

        public BorderImportPermitActualAmendmentReportController(TradeNetDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Excel([FromBody] BorderImportPermitActualAmendmentReportRequest? request)
        {
            ...
            try
            {
                fileBytes = await ExcelGenerator.CreateWorkbookAsync(
                    query,
                    request!,
                    "Border Import Permit Actual Amendment Report");
            }
            ...
            return File(
                ...
                "BorderImportPermitActualAmendmentReport.xlsx");
        }
