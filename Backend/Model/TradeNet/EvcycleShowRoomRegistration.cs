...
[Table("EVCycleShowRoomRegistration")]
public partial class EvcycleShowRoomRegistration
{
    [Key]
    [StringLength(36)]
    [Unicode(false)]
    ...
    [StringLength(128)]
    public string? WarehouseStreetNumberStreetName { get; set; }

    [StringLength(128)]
    public string? WarehouseQuarterCityTownship { get; set; }
