...
[Table("BorderImportPermit")]
public partial class BorderImportPermit
{
    [Key]
    [StringLength(36)]
    [Unicode(false)]
    ...
    [StringLength(50)]
    public string ImportPermitNo { get; set; } = null!;

    [StringLength(50)]
    public string? OldImportPermitNo { get; set; }
    ...
    public string PortofShipmentId { get; set; } = null!;
