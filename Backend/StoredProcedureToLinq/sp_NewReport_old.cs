...
public sealed class sp_NewReport_oldRequest
{
...
public sealed class sp_NewReport_oldResult
{
...
public static class sp_NewReport_old
{
    ...
    public static IQueryable<sp_NewReport_oldResult> Query(
        TradeNetDbContext db,
        sp_NewReport_oldRequest request)
    {
    ...
    private static IQueryable<sp_NewReport_oldResult> ExportLicenceQuery(
        TradeNetDbContext db,
        sp_NewReport_oldRequest request)
    {
        return
            ...
            select new sp_NewReport_oldResult
            {
    ...
    private static IQueryable<sp_NewReport_oldResult> ImportLicenceQuery(
        TradeNetDbContext db,
        sp_NewReport_oldRequest request)
    {
        return
    ...
    private static IQueryable<sp_NewReport_oldResult> ExportPermitQuery(
        TradeNetDbContext db,
        sp_NewReport_oldRequest request)
    {
        return
    ...
    private static IQueryable<sp_NewReport_oldResult> ImportPermitQuery(
        TradeNetDbContext db,
        sp_NewReport_oldRequest request)
    {
        return
    ...
    private static IQueryable<sp_NewReport_oldResult> BorderExportLicenceQuery(
        TradeNetDbContext db,
        sp_NewReport_oldRequest request)
    {
        var paThaKaQuery =
    ...
    private static IQueryable<sp_NewReport_oldResult> BorderImportLicenceQuery(
        TradeNetDbContext db,
        sp_NewReport_oldRequest request)
    {
        var paThaKaQuery =
    ...
    private static IQueryable<sp_NewReport_oldResult> BorderExportPermitQuery(
        TradeNetDbContext db,
        sp_NewReport_oldRequest request)
    {
        return
    ...
    private static IQueryable<sp_NewReport_oldResult> BorderImportPermitQuery(
        TradeNetDbContext db,
        sp_NewReport_oldRequest request)
    {
        return
    ...
    private static IQueryable<sp_NewReport_oldResult> EmptyQuery(TradeNetDbContext db)
    {
        return db.ExportLicences
            .Where(_ => false)
            .Select(_ => new sp_NewReport_oldResult());
    }
}
