...
public sealed class sp_ExtensionReportRequest
{
...
public sealed class sp_ExtensionReportResult
{
...
public sealed class sp_ExtensionReportRow
{
    public DateTime? Date { get; set; }
    public string? SectionCode { get; set; }
    public string? SectionName { get; set; }
...
public static class sp_ExtensionReport
{
    ...
    /// <summary>
    /// Executes <c>dbo.sp_ExtensionReport_pagination</c> (DB-side paging via INSERT-EXEC
    ...
    /// </summary>
    public static async Task<List<sp_ExtensionReportRow>> ExecuteAsync(
    ...
    private static IQueryable<sp_ExtensionReportResult> ExportLicenceQuery(
        TradeNetDbContext db,
        sp_ExtensionReportRequest request)
    {
        var amountByLicence =
        ...
        return
            ...
            select new sp_ExtensionReportResult
            {
    ...
    private static IQueryable<sp_ExtensionReportResult> ImportLicenceQuery(
        TradeNetDbContext db,
        sp_ExtensionReportRequest request)
    {
        var amountByLicence =
    ...
    private static IQueryable<sp_ExtensionReportResult> ExportPermitQuery(
        TradeNetDbContext db,
        sp_ExtensionReportRequest request)
    {
        var amountByPermit =
    ...
    private static IQueryable<sp_ExtensionReportResult> ImportPermitQuery(
        TradeNetDbContext db,
        sp_ExtensionReportRequest request)
    {
        var amountByPermit =
    ...
    private static IQueryable<sp_ExtensionReportResult> BorderExportLicenceQuery(
        TradeNetDbContext db,
        sp_ExtensionReportRequest request)
    {
        var amountByLicence =
    ...
    private static IQueryable<sp_ExtensionReportResult> BorderImportLicenceQuery(
        TradeNetDbContext db,
        sp_ExtensionReportRequest request)
    {
        var amountByLicence =
    ...
    private static IQueryable<sp_ExtensionReportResult> BorderExportPermitQuery(
        TradeNetDbContext db,
        sp_ExtensionReportRequest request)
    {
        var amountByPermit =
    ...
    private static IQueryable<sp_ExtensionReportResult> BorderImportPermitQuery(
        TradeNetDbContext db,
        sp_ExtensionReportRequest request)
    {
        var amountByPermit =
    ...
    private static IQueryable<sp_ExtensionReportResult> EmptyQuery(TradeNetDbContext db)
    {
        return db.ExportLicences
            .Where(_ => false)
            .Select(licence => new sp_ExtensionReportResult
            {
                Date = licence.CreatedDate,
