...
public sealed class sp_EVShowRoomRegistrationReportRequest
{
...
public sealed class sp_EVShowRoomRegistrationReportResult
{
...
public static class sp_EVShowRoomRegistrationReport
{
    private const string Approved = "Approved";
    private const string CurrentNrcType = "Current";
    private const string OldNrcType = "Old";

    public static IQueryable<sp_EVShowRoomRegistrationReportResult> Query(
        TradeNetDbContext db,
        sp_EVShowRoomRegistrationReportRequest request)
    {
        ArgumentNullException.ThrowIfNull(db);
        ArgumentNullException.ThrowIfNull(request);

        return from registration in db.EvshowRoomRegistrations
               ...
               select new sp_EVShowRoomRegistrationReportResult
               {
