...
public static class ExportPermitListingCurrencyTotals
{
    ...
    /// <summary>
    /// Voucher report footer (<c>dbo.sp_ExportPermitVoucherCurrencyTotals</c>).
    ///
    /// UNUSED since the 2026-09-04 "Total Amount" parity fix, and kept only as the record of what is
    /// deployed. It sums {Border,}ExportPermitItem.Amount -- the goods value, in the permit's own currency -- which is the
