...
public sealed class sp_ActualAmendReportRequest
{
...
public sealed class sp_ActualAmendReportResult
{
...
public sealed class sp_ActualAmendReportRow
{
    public DateTime? Date { get; set; }
    public string? SectionCode { get; set; }
    public string? SectionName { get; set; }
    ...
    public sp_ActualAmendReportResult ToResult() => new()
    {
        Date = Date,
...
public static class sp_ActualAmendReport
{
    private const string ActualAmend = "Actual Amend";
    private const string Approved = "Approved";
    private const string PaThaKaCardType = "Pa Tha Ka";
    private const string IndividualTradingCardType = "Individual Trading";

    /// <summary>
    /// Executes <c>dbo.sp_ActualAmendReport_pagination</c> (DB-side paging via INSERT-EXEC
    ...
    /// </summary>
    public static async Task<List<sp_ActualAmendReportRow>> ExecuteAsync(
    ...
    private static IQueryable<sp_ActualAmendReportResult> ExportLicenceQuery(
        TradeNetDbContext db,
        sp_ActualAmendReportRequest request)
    {
        ...
        return
            ...
            select new sp_ActualAmendReportResult
            {
    ...
    private static IQueryable<sp_ActualAmendReportResult> ImportLicenceQuery(
        TradeNetDbContext db,
        sp_ActualAmendReportRequest request)
    {
        var currencyByLicence =
    ...
    private static IQueryable<sp_ActualAmendReportResult> ExportPermitQuery(
        TradeNetDbContext db,
        sp_ActualAmendReportRequest request)
    {
    ...
    private static IQueryable<sp_ActualAmendReportResult> ImportPermitQuery(
        TradeNetDbContext db,
        sp_ActualAmendReportRequest request)
    {
        var currencyByPermit =
    ...
    private static IQueryable<sp_ActualAmendReportResult> BorderExportLicenceQuery(
        TradeNetDbContext db,
        sp_ActualAmendReportRequest request)
    {
        var currencyByLicence =
    ...
    private static IQueryable<sp_ActualAmendReportResult> BorderImportLicenceQuery(
        TradeNetDbContext db,
        sp_ActualAmendReportRequest request)
    {
        var currencyByLicence =
    ...
    private static IQueryable<sp_ActualAmendReportResult> BorderExportPermitQuery(
        TradeNetDbContext db,
        sp_ActualAmendReportRequest request)
    {
        var currencyByPermit =
    ...
    private static IQueryable<sp_ActualAmendReportResult> BorderImportPermitQuery(
        TradeNetDbContext db,
        sp_ActualAmendReportRequest request)
    {
        var currencyByPermit =
    ...
    private static IQueryable<sp_ActualAmendReportResult> EmptyQuery(TradeNetDbContext db)
    {
