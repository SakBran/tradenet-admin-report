...
public sealed class sp_EICCSubmitLicencePermitListRequest
{
    public string EICCStatus { get; set; } = string.Empty;
    public int UserId { get; set; }
}

public sealed class sp_EICCSubmitLicencePermitListResult
{
...
public static class sp_EICCSubmitLicencePermitList
{
    private const string Approved = "Approved";

    public static IQueryable<sp_EICCSubmitLicencePermitListResult> Query(
        TradeNetDbContext db,
        sp_EICCSubmitLicencePermitListRequest request)
    {
        ...
        return db.ExportLicences
            ...
            .Select(row => new sp_EICCSubmitLicencePermitListResult
            {
                Id = row.licence.Id,
